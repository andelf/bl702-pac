...
pub struct RegisterBlock {
    ...
    _reserved8: [u8; 0x0c],
    #[doc = "0x30 - pds_gpio_set_pu_pd."]
    pub pds_gpio_set_pu_pd: crate::Reg<pds_gpio_set_pu_pd::PDS_GPIO_SET_PU_PD_SPEC>,
    _reserved9: [u8; 0x0c],
    #[doc = "0x40 - pds_gpio_int."]
    pub pds_gpio_int: crate::Reg<pds_gpio_int::PDS_GPIO_INT_SPEC>,
    _reserved10: [u8; 0x02bc],
    ...
    #[doc = "0x420 - clkpll_test_enable."]
    pub clkpll_test_enable: crate::Reg<clkpll_test_enable::CLKPLL_TEST_ENABLE_SPEC>,
}
...
#[doc = "pds_ram1."]
pub mod pds_ram1;
#[doc = "pds_gpio_set_pu_pd register accessor: an alias for `Reg<PDS_GPIO_SET_PU_PD_SPEC>`"]
pub type PDS_GPIO_SET_PU_PD = crate::Reg<pds_gpio_set_pu_pd::PDS_GPIO_SET_PU_PD_SPEC>;
#[doc = "pds_gpio_set_pu_pd."]
pub mod pds_gpio_set_pu_pd;
#[doc = "pds_gpio_int register accessor: an alias for `Reg<PDS_GPIO_INT_SPEC>`"]
...
#[doc = "clkpll_test_enable register accessor: an alias for `Reg<CLKPLL_TEST_ENABLE_SPEC>`"]
pub type CLKPLL_TEST_ENABLE = crate::Reg<clkpll_test_enable::CLKPLL_TEST_ENABLE_SPEC>;
#[doc = "clkpll_test_enable."]
pub mod clkpll_test_enable;
