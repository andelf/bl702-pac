...
pub struct RegisterBlock {
    ...
    pub pds_gpio_set_pu_pd: PDS_GPIO_SET_PU_PD,
    _reserved9: [u8; 0x0c],
    ...
    pub clkpll_test_enable: CLKPLL_TEST_ENABLE,
}
...
#[doc = "pds_ram1."]
pub mod pds_ram1;
#[doc = "pds_gpio_set_pu_pd (rw) register accessor: an alias for `Reg<PDS_GPIO_SET_PU_PD_SPEC>`"]
...
#[doc = "clkpll_test_enable (rw) register accessor: an alias for `Reg<CLKPLL_TEST_ENABLE_SPEC>`"]
