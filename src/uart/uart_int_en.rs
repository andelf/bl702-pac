...
pub type CR_URX_LSE_EN_R = crate::BitReader<bool>;
#[doc = "Field `cr_urx_lse_en` writer - "]
pub type CR_URX_LSE_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, UART_INT_EN_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
    ...
    pub fn cr_urx_lse_en(&self) -> CR_URX_LSE_EN_R {
        CR_URX_LSE_EN_R::new(((self.bits >> 8) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0"]
