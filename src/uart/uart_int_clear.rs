...
impl core::ops::Deref for CR_URX_LSE_CLR_R {
...
#[doc = "Field `cr_urx_lse_clr` writer - "]
pub struct CR_URX_LSE_CLR_W<'a> {
    w: &'a mut W,
}
impl<'a> CR_URX_LSE_CLR_W<'a> {
...
impl R {
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn cr_urx_lse_clr(&self) -> CR_URX_LSE_CLR_R {
        CR_URX_LSE_CLR_R::new(((self.bits >> 8) & 0x01) != 0)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn cr_urx_lse_clr(&mut self) -> CR_URX_LSE_CLR_W {
        CR_URX_LSE_CLR_W { w: self }
    }
    #[doc = "Bit 7"]
    #[inline(always)]
