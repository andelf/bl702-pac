...
impl core::ops::Deref for CR_UTX_BIT_CNT_B_R {
...
#[doc = "Field `cr_utx_bit_cnt_b` writer - "]
pub struct CR_UTX_BIT_CNT_B_W<'a> {
    w: &'a mut W,
}
impl<'a> CR_UTX_BIT_CNT_B_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
impl core::ops::Deref for CR_UTX_LIN_EN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `cr_utx_lin_en` writer - "]
pub struct CR_UTX_LIN_EN_W<'a> {
    w: &'a mut W,
}
impl<'a> CR_UTX_LIN_EN_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    #[doc = "Bits 13:15"]
    #[inline(always)]
    pub fn cr_utx_bit_cnt_b(&self) -> CR_UTX_BIT_CNT_B_R {
        CR_UTX_BIT_CNT_B_R::new(((self.bits >> 13) & 0x07) as u8)
    }
    #[doc = "Bits 11:12"]
    #[inline(always)]
    pub fn cr_utx_bit_cnt_p(&self) -> CR_UTX_BIT_CNT_P_R {
        CR_UTX_BIT_CNT_P_R::new(((self.bits >> 11) & 0x03) as u8)
    }
    #[doc = "Bits 8:10"]
    #[inline(always)]
    ...
    #[doc = "Bit 3"]
    #[inline(always)]
    pub fn cr_utx_lin_en(&self) -> CR_UTX_LIN_EN_R {
        CR_UTX_LIN_EN_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bits 13:15"]
    #[inline(always)]
    pub fn cr_utx_bit_cnt_b(&mut self) -> CR_UTX_BIT_CNT_B_W {
        CR_UTX_BIT_CNT_B_W { w: self }
    }
    #[doc = "Bits 11:12"]
    #[inline(always)]
    ...
    #[doc = "Bit 3"]
    #[inline(always)]
    pub fn cr_utx_lin_en(&mut self) -> CR_UTX_LIN_EN_W {
        CR_UTX_LIN_EN_W { w: self }
    }
    #[doc = "Bit 2"]
    #[inline(always)]
