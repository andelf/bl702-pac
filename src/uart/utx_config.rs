...
pub type CR_UTX_LIN_EN_R = crate::BitReader<bool>;
#[doc = "Field `cr_utx_lin_en` writer - "]
pub type CR_UTX_LIN_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, UTX_CONFIG_SPEC, bool, O>;
...
pub type CR_UTX_BIT_CNT_B_R = crate::FieldReader<u8, u8>;
#[doc = "Field `cr_utx_bit_cnt_b` writer - "]
pub type CR_UTX_BIT_CNT_B_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, UTX_CONFIG_SPEC, u8, u8, 3, O>;
...
impl R {
    ...
    pub fn cr_utx_lin_en(&self) -> CR_UTX_LIN_EN_R {
        CR_UTX_LIN_EN_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    ...
    pub fn cr_utx_bit_cnt_p(&self) -> CR_UTX_BIT_CNT_P_R {
        CR_UTX_BIT_CNT_P_R::new(((self.bits >> 11) & 3) as u8)
    }
    #[doc = "Bits 13:15"]
    #[inline(always)]
    pub fn cr_utx_bit_cnt_b(&self) -> CR_UTX_BIT_CNT_B_R {
        CR_UTX_BIT_CNT_B_R::new(((self.bits >> 13) & 7) as u8)
    }
    #[doc = "Bits 16:31"]
    #[inline(always)]
