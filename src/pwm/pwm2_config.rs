#[doc = "Register `pwm2_config` reader"]
pub struct R(crate::R<PWM2_CONFIG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PWM2_CONFIG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PWM2_CONFIG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PWM2_CONFIG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `pwm2_config` writer"]
pub struct W(crate::W<PWM2_CONFIG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PWM2_CONFIG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PWM2_CONFIG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PWM2_CONFIG_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "pwm2_config.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pwm2_config](index.html) module"]
pub struct PWM2_CONFIG_SPEC;
impl crate::RegisterSpec for PWM2_CONFIG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pwm2_config::R](R) reader structure"]
impl crate::Readable for PWM2_CONFIG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pwm2_config::W](W) writer structure"]
