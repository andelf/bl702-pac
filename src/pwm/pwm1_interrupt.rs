#[doc = "Register `pwm1_interrupt` reader"]
pub struct R(crate::R<PWM1_INTERRUPT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PWM1_INTERRUPT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PWM1_INTERRUPT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PWM1_INTERRUPT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `pwm1_interrupt` writer"]
pub struct W(crate::W<PWM1_INTERRUPT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PWM1_INTERRUPT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PWM1_INTERRUPT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PWM1_INTERRUPT_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PWM_INT_PERIOD_CNT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PWM1_INTERRUPT_SPEC, u16, u16, 16, O>;
...
pub type PWM_INT_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PWM1_INTERRUPT_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
...
#[doc = "pwm1_interrupt.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pwm1_interrupt](index.html) module"]
pub struct PWM1_INTERRUPT_SPEC;
impl crate::RegisterSpec for PWM1_INTERRUPT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pwm1_interrupt::R](R) reader structure"]
impl crate::Readable for PWM1_INTERRUPT_SPEC {
    type Reader = R;
}
