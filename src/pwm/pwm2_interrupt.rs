...
pub struct R(crate::R<PWM2_INTERRUPT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PWM2_INTERRUPT_SPEC>;
    #[inline(always)]
...
pub struct W(crate::W<PWM2_INTERRUPT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PWM2_INTERRUPT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
#[doc = "pwm2_interrupt.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pwm2_interrupt](index.html) module"]
pub struct PWM2_INTERRUPT_SPEC;
impl crate::RegisterSpec for PWM2_INTERRUPT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pwm2_interrupt::R](R) reader structure"]
impl crate::Readable for PWM2_INTERRUPT_SPEC {
    type Reader = R;
}
