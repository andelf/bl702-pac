...
pub type RAW_INT_TCSTATUS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DMA_RAW_INT_TCSTATUS_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:7"]
    #[inline(always)]
    pub fn raw_int_tcstatus(&mut self) -> RAW_INT_TCSTATUS_W<0> {
        RAW_INT_TCSTATUS_W::new(self)
    }
