...
pub type INT_TCSTATUS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DMA_INT_TCSTATUS_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int_tcstatus(&mut self) -> INT_TCSTATUS_W<0> {
        INT_TCSTATUS_W::new(self)
    }
