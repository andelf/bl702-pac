...
pub struct R(crate::R<DMA_C2SRCADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMA_C2SRCADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMA_C2SRCADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMA_C2SRCADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMA_C2SrcAddr` writer"]
pub struct W(crate::W<DMA_C2SRCADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMA_C2SRCADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMA_C2SRCADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMA_C2SRCADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct DMA_C2SRCADDR_SPEC;
impl crate::RegisterSpec for DMA_C2SRCADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dma_c2src_addr::R](R) reader structure"]
impl crate::Readable for DMA_C2SRCADDR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dma_c2src_addr::W](W) writer structure"]
impl crate::Writable for DMA_C2SRCADDR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DMA_C2SrcAddr to value 0"]
impl crate::Resettable for DMA_C2SRCADDR_SPEC {
    #[inline(always)]
