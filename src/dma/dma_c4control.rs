#[doc = "Register `DMA_C4Control` reader"]
pub struct R(crate::R<DMA_C4CONTROL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMA_C4CONTROL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMA_C4CONTROL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMA_C4CONTROL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMA_C4Control` writer"]
pub struct W(crate::W<DMA_C4CONTROL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMA_C4CONTROL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMA_C4CONTROL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMA_C4CONTROL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TRANSFER_SIZE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DMA_C4CONTROL_SPEC, u16, u16, 12, O>;
#[doc = "Field `SBSize` reader - "]
pub type SBSIZE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SBSize` writer - "]
pub type SBSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_C4CONTROL_SPEC, u8, u8, 2, O>;
#[doc = "Field `dst_min_mode` reader - "]
pub type DST_MIN_MODE_R = crate::BitReader<bool>;
#[doc = "Field `dst_min_mode` writer - "]
pub type DST_MIN_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_C4CONTROL_SPEC, bool, O>;
#[doc = "Field `DBSize` reader - "]
pub type DBSIZE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DBSize` writer - "]
pub type DBSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_C4CONTROL_SPEC, u8, u8, 2, O>;
#[doc = "Field `dst_add_mode` reader - "]
pub type DST_ADD_MODE_R = crate::BitReader<bool>;
#[doc = "Field `dst_add_mode` writer - "]
pub type DST_ADD_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_C4CONTROL_SPEC, bool, O>;
#[doc = "Field `SWidth` reader - "]
pub type SWIDTH_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SWidth` writer - "]
pub type SWIDTH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_C4CONTROL_SPEC, u8, u8, 3, O>;
#[doc = "Field `DWidth` reader - "]
pub type DWIDTH_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DWidth` writer - "]
pub type DWIDTH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_C4CONTROL_SPEC, u8, u8, 3, O>;
#[doc = "Field `fix_cnt` reader - "]
pub type FIX_CNT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `fix_cnt` writer - "]
pub type FIX_CNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_C4CONTROL_SPEC, u8, u8, 2, O>;
#[doc = "Field `SI` reader - "]
pub type SI_R = crate::BitReader<bool>;
#[doc = "Field `SI` writer - "]
pub type SI_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_C4CONTROL_SPEC, bool, O>;
#[doc = "Field `DI` reader - "]
pub type DI_R = crate::BitReader<bool>;
#[doc = "Field `DI` writer - "]
pub type DI_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_C4CONTROL_SPEC, bool, O>;
#[doc = "Field `Prot` reader - "]
pub type PROT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `Prot` writer - "]
pub type PROT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_C4CONTROL_SPEC, u8, u8, 3, O>;
#[doc = "Field `I` reader - "]
pub type I_R = crate::BitReader<bool>;
#[doc = "Field `I` writer - "]
pub type I_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_C4CONTROL_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:11"]
    #[inline(always)]
...
pub struct DMA_C4CONTROL_SPEC;
impl crate::RegisterSpec for DMA_C4CONTROL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dma_c4control::R](R) reader structure"]
impl crate::Readable for DMA_C4CONTROL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dma_c4control::W](W) writer structure"]
impl crate::Writable for DMA_C4CONTROL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DMA_C4Control to value 0"]
impl crate::Resettable for DMA_C4CONTROL_SPEC {
    #[inline(always)]
