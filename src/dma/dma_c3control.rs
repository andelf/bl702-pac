...
impl From<crate::R<DMA_C3CONTROL_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<DMA_C3CONTROL_SPEC>> for W {
    #[inline(always)]
...
pub type TRANSFER_SIZE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DMA_C3CONTROL_SPEC, u16, u16, 12, O>;
#[doc = "Field `SBSize` reader - "]
pub type SBSIZE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SBSize` writer - "]
pub type SBSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_C3CONTROL_SPEC, u8, u8, 2, O>;
#[doc = "Field `dst_min_mode` reader - "]
pub type DST_MIN_MODE_R = crate::BitReader<bool>;
#[doc = "Field `dst_min_mode` writer - "]
pub type DST_MIN_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_C3CONTROL_SPEC, bool, O>;
#[doc = "Field `DBSize` reader - "]
pub type DBSIZE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DBSize` writer - "]
pub type DBSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_C3CONTROL_SPEC, u8, u8, 2, O>;
#[doc = "Field `dst_add_mode` reader - "]
pub type DST_ADD_MODE_R = crate::BitReader<bool>;
#[doc = "Field `dst_add_mode` writer - "]
pub type DST_ADD_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_C3CONTROL_SPEC, bool, O>;
#[doc = "Field `SWidth` reader - "]
pub type SWIDTH_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SWidth` writer - "]
pub type SWIDTH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_C3CONTROL_SPEC, u8, u8, 3, O>;
#[doc = "Field `DWidth` reader - "]
pub type DWIDTH_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DWidth` writer - "]
pub type DWIDTH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_C3CONTROL_SPEC, u8, u8, 3, O>;
#[doc = "Field `fix_cnt` reader - "]
pub type FIX_CNT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `fix_cnt` writer - "]
pub type FIX_CNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_C3CONTROL_SPEC, u8, u8, 2, O>;
#[doc = "Field `SI` reader - "]
pub type SI_R = crate::BitReader<bool>;
#[doc = "Field `SI` writer - "]
pub type SI_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_C3CONTROL_SPEC, bool, O>;
#[doc = "Field `DI` reader - "]
pub type DI_R = crate::BitReader<bool>;
#[doc = "Field `DI` writer - "]
pub type DI_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_C3CONTROL_SPEC, bool, O>;
#[doc = "Field `Prot` reader - "]
pub type PROT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `Prot` writer - "]
pub type PROT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_C3CONTROL_SPEC, u8, u8, 3, O>;
#[doc = "Field `I` reader - "]
pub type I_R = crate::BitReader<bool>;
#[doc = "Field `I` writer - "]
pub type I_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_C3CONTROL_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:11"]
    #[inline(always)]
