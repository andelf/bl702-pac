...
#[doc = "Field `A` writer - "]
pub type A_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_C0CONFIG_SPEC, bool, O>;
#[doc = "Field `H` reader - "]
...
pub type LLICOUNTER_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DMA_C0CONFIG_SPEC, u16, u16, 10, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn e(&self) -> E_R {
...
impl W {
    ...
    #[doc = "Bits 20:29"]
    #[inline(always)]
    pub fn llicounter(&mut self) -> LLICOUNTER_W<20> {
        LLICOUNTER_W::new(self)
    }
