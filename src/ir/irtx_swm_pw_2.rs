...
pub struct CR_IRTX_SWM_PW_2_R(crate::FieldReader<u32, u32>);
impl CR_IRTX_SWM_PW_2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CR_IRTX_SWM_PW_2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CR_IRTX_SWM_PW_2_R {
...
pub struct CR_IRTX_SWM_PW_2_W<'a> {
    w: &'a mut W,
}
impl<'a> CR_IRTX_SWM_PW_2_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn cr_irtx_swm_pw_2(&mut self) -> CR_IRTX_SWM_PW_2_W {
        CR_IRTX_SWM_PW_2_W { w: self }
    }
