...
pub type IRRX_END_INT_W<'a, const O: u8> = crate::BitWriter<'a, u32, IRRX_INT_STS_SPEC, bool, O>;
...
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn irrx_end_int(&mut self) -> IRRX_END_INT_W<0> {
        IRRX_END_INT_W::new(self)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
