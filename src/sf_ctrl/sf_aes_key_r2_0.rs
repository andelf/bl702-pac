...
impl From<crate::R<SF_AES_KEY_R2_0_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<SF_AES_KEY_R2_0_SPEC>> for W {
    #[inline(always)]
...
pub type SF_AES_KEY_R2_0_R = crate::FieldReader<u32, u32>;
#[doc = "Field `sf_aes_key_r2_0` writer - "]
pub type SF_AES_KEY_R2_0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SF_AES_KEY_R2_0_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn sf_aes_key_r2_0(&self) -> SF_AES_KEY_R2_0_R {
        SF_AES_KEY_R2_0_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn sf_aes_key_r2_0(&mut self) -> SF_AES_KEY_R2_0_W<0> {
        SF_AES_KEY_R2_0_W::new(self)
    }
