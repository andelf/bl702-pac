...
pub type SF_IF_SR_INT_W<'a, const O: u8> = crate::BitWriter<'a, u32, SF_CTRL_1_SPEC, bool, O>;
...
pub type SF_AHB2SIF_STOPPED_W<'a, const O: u8> = crate::BitWriter<'a, u32, SF_CTRL_1_SPEC, bool, O>;
