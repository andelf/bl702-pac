...
pub struct SF_IF_4_CMD_BUF_1_R(crate::FieldReader<u32, u32>);
impl SF_IF_4_CMD_BUF_1_R {
    pub(crate) fn new(bits: u32) -> Self {
        SF_IF_4_CMD_BUF_1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SF_IF_4_CMD_BUF_1_R {
...
pub struct SF_IF_4_CMD_BUF_1_W<'a> {
    w: &'a mut W,
}
impl<'a> SF_IF_4_CMD_BUF_1_W<'a> {
...
impl R {
    ...
    pub fn sf_if_4_cmd_buf_1(&self) -> SF_IF_4_CMD_BUF_1_R {
        SF_IF_4_CMD_BUF_1_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn sf_if_4_cmd_buf_1(&mut self) -> SF_IF_4_CMD_BUF_1_W {
        SF_IF_4_CMD_BUF_1_W { w: self }
    }
