...
pub type SF_IF_1_CMD_BUF_1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `sf_if_1_cmd_buf_1` writer - "]
pub type SF_IF_1_CMD_BUF_1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SF_IF_IAHB_2_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn sf_if_1_cmd_buf_1(&mut self) -> SF_IF_1_CMD_BUF_1_W<0> {
        SF_IF_1_CMD_BUF_1_W::new(self)
    }
