...
impl core::ops::Deref for SF_CMDS_WRAP_Q_R {
...
#[doc = "Field `sf_cmds_wrap_q` writer - "]
pub struct SF_CMDS_WRAP_Q_W<'a> {
    w: &'a mut W,
}
impl<'a> SF_CMDS_WRAP_Q_W<'a> {
...
impl R {
    ...
    #[doc = "Bit 11"]
    #[inline(always)]
    pub fn sf_cmds_wrap_q(&self) -> SF_CMDS_WRAP_Q_R {
        SF_CMDS_WRAP_Q_R::new(((self.bits >> 11) & 0x01) != 0)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 11"]
    #[inline(always)]
    pub fn sf_cmds_wrap_q(&mut self) -> SF_CMDS_WRAP_Q_W {
        SF_CMDS_WRAP_Q_W { w: self }
    }
    #[doc = "Bit 10"]
    #[inline(always)]
