...
pub type SF_CMDS_WRAP_Q_R = crate::BitReader<bool>;
#[doc = "Field `sf_cmds_wrap_q` writer - "]
pub type SF_CMDS_WRAP_Q_W<'a, const O: u8> = crate::BitWriter<'a, u32, SF_CTRL_3_SPEC, bool, O>;
...
impl R {
    ...
    pub fn sf_cmds_wrap_q(&self) -> SF_CMDS_WRAP_Q_R {
        SF_CMDS_WRAP_Q_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bits 29:31"]
    #[inline(always)]
