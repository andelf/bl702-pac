...
pub type SF_IF_STATUS_1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SF_IF_STATUS_1_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sf_if_status_1(&mut self) -> SF_IF_STATUS_1_W<0> {
        SF_IF_STATUS_1_W::new(self)
    }
