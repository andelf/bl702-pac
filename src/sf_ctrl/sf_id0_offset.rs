...
pub type SF_ID0_OFFSET_R = crate::FieldReader<u32, u32>;
#[doc = "Field `sf_id0_offset` writer - "]
pub type SF_ID0_OFFSET_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SF_ID0_OFFSET_SPEC, u32, u32, 24, O>;
impl R {
    #[doc = "Bits 0:23"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:23"]
    #[inline(always)]
    pub fn sf_id0_offset(&mut self) -> SF_ID0_OFFSET_W<0> {
        SF_ID0_OFFSET_W::new(self)
    }
