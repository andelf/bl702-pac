...
pub struct SF_AES_KEY_R1_0_R(crate::FieldReader<u32, u32>);
impl SF_AES_KEY_R1_0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SF_AES_KEY_R1_0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SF_AES_KEY_R1_0_R {
...
pub struct SF_AES_KEY_R1_0_W<'a> {
    w: &'a mut W,
}
impl<'a> SF_AES_KEY_R1_0_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn sf_aes_key_r1_0(&mut self) -> SF_AES_KEY_R1_0_W {
        SF_AES_KEY_R1_0_W { w: self }
    }
