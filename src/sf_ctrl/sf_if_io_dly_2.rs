...
pub struct SF_IO_1_DO_DLY_SEL_R(crate::FieldReader<u8, u8>);
impl SF_IO_1_DO_DLY_SEL_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        SF_IO_1_DO_DLY_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SF_IO_1_DO_DLY_SEL_R {
...
pub struct SF_IO_1_DO_DLY_SEL_W<'a> {
    w: &'a mut W,
}
impl<'a> SF_IO_1_DO_DLY_SEL_W<'a> {
...
pub struct SF_IO_1_DI_DLY_SEL_R(crate::FieldReader<u8, u8>);
impl SF_IO_1_DI_DLY_SEL_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        SF_IO_1_DI_DLY_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SF_IO_1_DI_DLY_SEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct SF_IO_1_DI_DLY_SEL_W<'a> {
    w: &'a mut W,
}
impl<'a> SF_IO_1_DI_DLY_SEL_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
pub struct SF_IO_1_OE_DLY_SEL_R(crate::FieldReader<u8, u8>);
impl SF_IO_1_OE_DLY_SEL_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        SF_IO_1_OE_DLY_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SF_IO_1_OE_DLY_SEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct SF_IO_1_OE_DLY_SEL_W<'a> {
    w: &'a mut W,
}
impl<'a> SF_IO_1_OE_DLY_SEL_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl R {
    ...
    pub fn sf_io_1_do_dly_sel(&self) -> SF_IO_1_DO_DLY_SEL_R {
        SF_IO_1_DO_DLY_SEL_R::new(((self.bits >> 16) & 0x03) as u8)
    }
    #[doc = "Bits 8:9"]
    #[inline(always)]
    pub fn sf_io_1_di_dly_sel(&self) -> SF_IO_1_DI_DLY_SEL_R {
        SF_IO_1_DI_DLY_SEL_R::new(((self.bits >> 8) & 0x03) as u8)
    }
    #[doc = "Bits 0:1"]
    #[inline(always)]
    pub fn sf_io_1_oe_dly_sel(&self) -> SF_IO_1_OE_DLY_SEL_R {
        SF_IO_1_OE_DLY_SEL_R::new((self.bits & 0x03) as u8)
    }
}
impl W {
    #[doc = "Bits 16:17"]
    #[inline(always)]
    pub fn sf_io_1_do_dly_sel(&mut self) -> SF_IO_1_DO_DLY_SEL_W {
        SF_IO_1_DO_DLY_SEL_W { w: self }
    }
    #[doc = "Bits 8:9"]
    #[inline(always)]
    pub fn sf_io_1_di_dly_sel(&mut self) -> SF_IO_1_DI_DLY_SEL_W {
        SF_IO_1_DI_DLY_SEL_W { w: self }
    }
    #[doc = "Bits 0:1"]
    #[inline(always)]
    pub fn sf_io_1_oe_dly_sel(&mut self) -> SF_IO_1_OE_DLY_SEL_W {
        SF_IO_1_OE_DLY_SEL_W { w: self }
    }
