...
pub struct SF_IF_4_CMD_BUF_0_R(crate::FieldReader<u32, u32>);
impl SF_IF_4_CMD_BUF_0_R {
    pub(crate) fn new(bits: u32) -> Self {
        SF_IF_4_CMD_BUF_0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SF_IF_4_CMD_BUF_0_R {
...
pub struct SF_IF_4_CMD_BUF_0_W<'a> {
    w: &'a mut W,
}
impl<'a> SF_IF_4_CMD_BUF_0_W<'a> {
...
impl R {
    ...
    pub fn sf_if_4_cmd_buf_0(&self) -> SF_IF_4_CMD_BUF_0_R {
        SF_IF_4_CMD_BUF_0_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn sf_if_4_cmd_buf_0(&mut self) -> SF_IF_4_CMD_BUF_0_W {
        SF_IF_4_CMD_BUF_0_W { w: self }
    }
