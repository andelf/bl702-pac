...
pub type SF_AES_KEY_R0_5_R = crate::FieldReader<u32, u32>;
#[doc = "Field `sf_aes_key_r0_5` writer - "]
pub type SF_AES_KEY_R0_5_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SF_AES_KEY_R0_5_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn sf_aes_key_r0_5(&mut self) -> SF_AES_KEY_R0_5_W<0> {
        SF_AES_KEY_R0_5_W::new(self)
    }
