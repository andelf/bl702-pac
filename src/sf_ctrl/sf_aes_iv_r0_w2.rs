...
pub struct SF_AES_IV_R0_W2_R(crate::FieldReader<u32, u32>);
impl SF_AES_IV_R0_W2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SF_AES_IV_R0_W2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SF_AES_IV_R0_W2_R {
...
pub struct SF_AES_IV_R0_W2_W<'a> {
    w: &'a mut W,
}
impl<'a> SF_AES_IV_R0_W2_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn sf_aes_iv_r0_w2(&mut self) -> SF_AES_IV_R0_W2_W {
        SF_AES_IV_R0_W2_W { w: self }
    }
