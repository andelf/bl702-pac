...
pub struct SF_AES_KEY_R2_4_R(crate::FieldReader<u32, u32>);
impl SF_AES_KEY_R2_4_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SF_AES_KEY_R2_4_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SF_AES_KEY_R2_4_R {
...
pub struct SF_AES_KEY_R2_4_W<'a> {
    w: &'a mut W,
}
impl<'a> SF_AES_KEY_R2_4_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn sf_aes_key_r2_4(&mut self) -> SF_AES_KEY_R2_4_W {
        SF_AES_KEY_R2_4_W { w: self }
    }
