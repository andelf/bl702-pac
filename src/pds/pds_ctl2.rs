...
pub type CR_PDS_FORCE_BZ_PWR_OFF_R = crate::BitReader<bool>;
#[doc = "Field `cr_pds_force_bz_pwr_off` writer - "]
pub type CR_PDS_FORCE_BZ_PWR_OFF_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDS_CTL2_SPEC, bool, O>;
...
pub type CR_PDS_FORCE_BZ_ISO_EN_R = crate::BitReader<bool>;
#[doc = "Field `cr_pds_force_bz_iso_en` writer - "]
pub type CR_PDS_FORCE_BZ_ISO_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDS_CTL2_SPEC, bool, O>;
...
pub type CR_PDS_FORCE_BZ_PDS_RST_R = crate::BitReader<bool>;
#[doc = "Field `cr_pds_force_bz_pds_rst` writer - "]
pub type CR_PDS_FORCE_BZ_PDS_RST_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDS_CTL2_SPEC, bool, O>;
...
pub type CR_PDS_FORCE_BZ_MEM_STBY_R = crate::BitReader<bool>;
#[doc = "Field `cr_pds_force_bz_mem_stby` writer - "]
pub type CR_PDS_FORCE_BZ_MEM_STBY_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDS_CTL2_SPEC, bool, O>;
...
pub type CR_PDS_FORCE_BZ_GATE_CLK_R = crate::BitReader<bool>;
#[doc = "Field `cr_pds_force_bz_gate_clk` writer - "]
pub type CR_PDS_FORCE_BZ_GATE_CLK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDS_CTL2_SPEC, bool, O>;
...
impl R {
    ...
    pub fn cr_pds_force_bz_pwr_off(&self) -> CR_PDS_FORCE_BZ_PWR_OFF_R {
        CR_PDS_FORCE_BZ_PWR_OFF_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    ...
    pub fn cr_pds_force_bz_iso_en(&self) -> CR_PDS_FORCE_BZ_ISO_EN_R {
        CR_PDS_FORCE_BZ_ISO_EN_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    ...
    pub fn cr_pds_force_bz_pds_rst(&self) -> CR_PDS_FORCE_BZ_PDS_RST_R {
        CR_PDS_FORCE_BZ_PDS_RST_R::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    ...
    pub fn cr_pds_force_bz_mem_stby(&self) -> CR_PDS_FORCE_BZ_MEM_STBY_R {
        CR_PDS_FORCE_BZ_MEM_STBY_R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    ...
    pub fn cr_pds_force_bz_gate_clk(&self) -> CR_PDS_FORCE_BZ_GATE_CLK_R {
        CR_PDS_FORCE_BZ_GATE_CLK_R::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn cr_pds_force_bz_pwr_off(&mut self) -> CR_PDS_FORCE_BZ_PWR_OFF_W<2> {
        CR_PDS_FORCE_BZ_PWR_OFF_W::new(self)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    ...
    #[doc = "Bit 6"]
    #[inline(always)]
    pub fn cr_pds_force_bz_iso_en(&mut self) -> CR_PDS_FORCE_BZ_ISO_EN_W<6> {
        CR_PDS_FORCE_BZ_ISO_EN_W::new(self)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    ...
    #[doc = "Bit 10"]
    #[inline(always)]
    pub fn cr_pds_force_bz_pds_rst(&mut self) -> CR_PDS_FORCE_BZ_PDS_RST_W<10> {
        CR_PDS_FORCE_BZ_PDS_RST_W::new(self)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    ...
    #[doc = "Bit 14"]
    #[inline(always)]
    pub fn cr_pds_force_bz_mem_stby(&mut self) -> CR_PDS_FORCE_BZ_MEM_STBY_W<14> {
        CR_PDS_FORCE_BZ_MEM_STBY_W::new(self)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    ...
    #[doc = "Bit 18"]
    #[inline(always)]
    pub fn cr_pds_force_bz_gate_clk(&mut self) -> CR_PDS_FORCE_BZ_GATE_CLK_W<18> {
        CR_PDS_FORCE_BZ_GATE_CLK_W::new(self)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
