...
pub type CR_PDS_CTRL_PU_FLASH_R = crate::BitReader<bool>;
#[doc = "Field `cr_pds_ctrl_pu_flash` writer - "]
pub type CR_PDS_CTRL_PU_FLASH_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDS_CTL_SPEC, bool, O>;
...
pub type CR_SW_PU_FLASH_R = crate::BitReader<bool>;
#[doc = "Field `cr_sw_pu_flash` writer - "]
pub type CR_SW_PU_FLASH_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDS_CTL_SPEC, bool, O>;
...
pub type CR_PDS_RAM_LP_WITH_CLK_EN_R = crate::BitReader<bool>;
#[doc = "Field `cr_pds_ram_lp_with_clk_en` writer - "]
pub type CR_PDS_RAM_LP_WITH_CLK_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDS_CTL_SPEC, bool, O>;
...
pub type CR_PDS_FORCE_RAM_CLK_EN_R = crate::BitReader<bool>;
#[doc = "Field `cr_pds_force_ram_clk_en` writer - "]
pub type CR_PDS_FORCE_RAM_CLK_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PDS_CTL_SPEC, bool, O>;
...
impl R {
    ...
    pub fn cr_pds_ctrl_pu_flash(&self) -> CR_PDS_CTRL_PU_FLASH_R {
        CR_PDS_CTRL_PU_FLASH_R::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    ...
    pub fn cr_sw_pu_flash(&self) -> CR_SW_PU_FLASH_R {
        CR_SW_PU_FLASH_R::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    ...
    pub fn cr_pds_ram_lp_with_clk_en(&self) -> CR_PDS_RAM_LP_WITH_CLK_EN_R {
        CR_PDS_RAM_LP_WITH_CLK_EN_R::new(((self.bits >> 19) & 1) != 0)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    ...
    pub fn cr_pds_force_ram_clk_en(&self) -> CR_PDS_FORCE_RAM_CLK_EN_R {
        CR_PDS_FORCE_RAM_CLK_EN_R::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bits 24:27"]
    #[inline(always)]
