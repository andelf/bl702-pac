...
pub type RC32M_CAL_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, RC32M_CTRL0_SPEC, bool, O>;
#[doc = "Field `rc32m_rdy` reader - "]
pub type RC32M_RDY_R = crate::BitReader<bool>;
#[doc = "Field `rc32m_rdy` writer - "]
pub type RC32M_RDY_W<'a, const O: u8> = crate::BitWriter<'a, u32, RC32M_CTRL0_SPEC, bool, O>;
...
pub type RC32M_CAL_INPROGRESS_W<'a, const O: u8> =
...
pub type RC32M_CAL_PRECHARGE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, RC32M_CTRL0_SPEC, bool, O>;
...
pub type RC32M_DIG_CODE_FR_CAL_W<'a, const O: u8> =
