...
impl From<crate::W<I2C_FIFO_RDATA_SPEC>> for W {
    #[inline(always)]
...
pub type I2C_FIFO_RDATA_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, I2C_FIFO_RDATA_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c_fifo_rdata(&mut self) -> I2C_FIFO_RDATA_W<0> {
        I2C_FIFO_RDATA_W::new(self)
    }
