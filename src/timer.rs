...
#[doc = "TCR3."]
pub mod tcr3;
#[doc = "TMSR2 (rw) register accessor: an alias for `Reg<TMSR2_SPEC>`"]
pub type TMSR2 = crate::Reg<tmsr2::TMSR2_SPEC>;
#[doc = "TMSR2."]
pub mod tmsr2;
#[doc = "TMSR3 (rw) register accessor: an alias for `Reg<TMSR3_SPEC>`"]
...
#[doc = "WMR."]
pub mod wmr;
#[doc = "WVR (rw) register accessor: an alias for `Reg<WVR_SPEC>`"]
...
#[doc = "WSR."]
pub mod wsr;
#[doc = "TICR2 (rw) register accessor: an alias for `Reg<TICR2_SPEC>`"]
pub type TICR2 = crate::Reg<ticr2::TICR2_SPEC>;
#[doc = "TICR2."]
pub mod ticr2;
#[doc = "TICR3 (rw) register accessor: an alias for `Reg<TICR3_SPEC>`"]
...
#[doc = "WCR."]
pub mod wcr;
#[doc = "WFAR (rw) register accessor: an alias for `Reg<WFAR_SPEC>`"]
pub type WFAR = crate::Reg<wfar::WFAR_SPEC>;
#[doc = "WFAR."]
pub mod wfar;
#[doc = "WSAR (rw) register accessor: an alias for `Reg<WSAR_SPEC>`"]
pub type WSAR = crate::Reg<wsar::WSAR_SPEC>;
#[doc = "WSAR."]
pub mod wsar;
#[doc = "TCVWR2 (rw) register accessor: an alias for `Reg<TCVWR2_SPEC>`"]
pub type TCVWR2 = crate::Reg<tcvwr2::TCVWR2_SPEC>;
#[doc = "TCVWR2."]
pub mod tcvwr2;
#[doc = "TCVWR3 (rw) register accessor: an alias for `Reg<TCVWR3_SPEC>`"]
pub type TCVWR3 = crate::Reg<tcvwr3::TCVWR3_SPEC>;
#[doc = "TCVWR3."]
pub mod tcvwr3;
#[doc = "TCVSYN2 (rw) register accessor: an alias for `Reg<TCVSYN2_SPEC>`"]
pub type TCVSYN2 = crate::Reg<tcvsyn2::TCVSYN2_SPEC>;
#[doc = "TCVSYN2."]
pub mod tcvsyn2;
#[doc = "TCVSYN3 (rw) register accessor: an alias for `Reg<TCVSYN3_SPEC>`"]
