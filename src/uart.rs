...
pub struct RegisterBlock {
    ...
    #[doc = "0x1c - uart_sw_mode."]
    pub uart_sw_mode: UART_SW_MODE,
...
#[doc = "uart_sw_mode (rw) register accessor: an alias for `Reg<UART_SW_MODE_SPEC>`"]
pub type UART_SW_MODE = crate::Reg<uart_sw_mode::UART_SW_MODE_SPEC>;
#[doc = "uart_sw_mode."]
pub mod uart_sw_mode;
#[doc = "uart_int_sts (rw) register accessor: an alias for `Reg<UART_INT_STS_SPEC>`"]
...
pub mod uart_int_en;
#[doc = "uart_status (rw) register accessor: an alias for `Reg<UART_STATUS_SPEC>`"]
pub type UART_STATUS = crate::Reg<uart_status::UART_STATUS_SPEC>;
#[doc = "uart_status."]
pub mod uart_status;
#[doc = "sts_urx_abr_prd (rw) register accessor: an alias for `Reg<STS_URX_ABR_PRD_SPEC>`"]
...
#[doc = "uart_fifo_wdata (rw) register accessor: an alias for `Reg<UART_FIFO_WDATA_SPEC>`"]
pub type UART_FIFO_WDATA = crate::Reg<uart_fifo_wdata::UART_FIFO_WDATA_SPEC>;
#[doc = "uart_fifo_wdata."]
pub mod uart_fifo_wdata;
#[doc = "uart_fifo_rdata (rw) register accessor: an alias for `Reg<UART_FIFO_RDATA_SPEC>`"]
