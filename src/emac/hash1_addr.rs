...
pub struct HASH1_R(crate::FieldReader<u32, u32>);
impl HASH1_R {
    pub(crate) fn new(bits: u32) -> Self {
        HASH1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HASH1_R {
...
impl R {
    ...
    pub fn hash1(&self) -> HASH1_R {
        HASH1_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn hash1(&mut self) -> HASH1_W {
        HASH1_W { w: self }
    }
