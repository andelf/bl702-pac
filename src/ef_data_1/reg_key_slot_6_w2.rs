...
pub struct REG_KEY_SLOT_6_W2_R(crate::FieldReader<u32, u32>);
impl REG_KEY_SLOT_6_W2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        REG_KEY_SLOT_6_W2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for REG_KEY_SLOT_6_W2_R {
...
pub struct REG_KEY_SLOT_6_W2_W<'a> {
    w: &'a mut W,
}
impl<'a> REG_KEY_SLOT_6_W2_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn reg_key_slot_6_w2(&mut self) -> REG_KEY_SLOT_6_W2_W {
        REG_KEY_SLOT_6_W2_W { w: self }
    }
