...
impl From<crate::R<REG_KEY_SLOT_8_W2_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<REG_KEY_SLOT_8_W2_SPEC>> for W {
    #[inline(always)]
...
pub type REG_KEY_SLOT_8_W2_R = crate::FieldReader<u32, u32>;
#[doc = "Field `reg_key_slot_8_w2` writer - "]
pub type REG_KEY_SLOT_8_W2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, REG_KEY_SLOT_8_W2_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn reg_key_slot_8_w2(&self) -> REG_KEY_SLOT_8_W2_R {
        REG_KEY_SLOT_8_W2_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn reg_key_slot_8_w2(&mut self) -> REG_KEY_SLOT_8_W2_W<0> {
        REG_KEY_SLOT_8_W2_W::new(self)
    }
