...
pub type REG_KEY_SLOT_8_W1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `reg_key_slot_8_w1` writer - "]
pub type REG_KEY_SLOT_8_W1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, REG_KEY_SLOT_8_W1_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn reg_key_slot_8_w1(&self) -> REG_KEY_SLOT_8_W1_R {
        REG_KEY_SLOT_8_W1_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn reg_key_slot_8_w1(&mut self) -> REG_KEY_SLOT_8_W1_W<0> {
        REG_KEY_SLOT_8_W1_W::new(self)
    }
