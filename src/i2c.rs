...
#[doc = "i2c_fifo_wdata (rw) register accessor: an alias for `Reg<I2C_FIFO_WDATA_SPEC>`"]
pub type I2C_FIFO_WDATA = crate::Reg<i2c_fifo_wdata::I2C_FIFO_WDATA_SPEC>;
#[doc = "i2c_fifo_wdata."]
pub mod i2c_fifo_wdata;
#[doc = "i2c_fifo_rdata (rw) register accessor: an alias for `Reg<I2C_FIFO_RDATA_SPEC>`"]
