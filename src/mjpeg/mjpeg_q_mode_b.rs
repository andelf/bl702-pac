...
pub struct FRAME_Q_MODE_B_R(crate::FieldReader<u8, u8>);
impl FRAME_Q_MODE_B_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        FRAME_Q_MODE_B_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FRAME_Q_MODE_B_R {
...
pub struct FRAME_Q_MODE_B_W<'a> {
    w: &'a mut W,
}
impl<'a> FRAME_Q_MODE_B_W<'a> {
...
impl W {
    #[doc = "Bits 0:6"]
    #[inline(always)]
    pub fn frame_q_mode_b(&mut self) -> FRAME_Q_MODE_B_W {
        FRAME_Q_MODE_B_W { w: self }
    }
