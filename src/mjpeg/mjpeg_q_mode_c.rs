...
pub type FRAME_Q_MODE_C_R = crate::FieldReader<u8, u8>;
#[doc = "Field `frame_q_mode_c` writer - "]
pub type FRAME_Q_MODE_C_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, MJPEG_Q_MODE_C_SPEC, u8, u8, 7, O>;
impl R {
    #[doc = "Bits 0:6"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:6"]
    #[inline(always)]
    pub fn frame_q_mode_c(&mut self) -> FRAME_Q_MODE_C_W<0> {
        FRAME_Q_MODE_C_W::new(self)
    }
