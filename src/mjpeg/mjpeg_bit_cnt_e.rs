...
pub struct FRAME_BIT_CNT_E_R(crate::FieldReader<u32, u32>);
impl FRAME_BIT_CNT_E_R {
    pub(crate) fn new(bits: u32) -> Self {
        FRAME_BIT_CNT_E_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FRAME_BIT_CNT_E_R {
...
pub struct FRAME_BIT_CNT_E_W<'a> {
    w: &'a mut W,
}
impl<'a> FRAME_BIT_CNT_E_W<'a> {
...
impl R {
    ...
    pub fn frame_bit_cnt_e(&self) -> FRAME_BIT_CNT_E_R {
        FRAME_BIT_CNT_E_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn frame_bit_cnt_e(&mut self) -> FRAME_BIT_CNT_E_W {
        FRAME_BIT_CNT_E_W { w: self }
    }
