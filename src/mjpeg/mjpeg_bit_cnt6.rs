...
pub type FRAME_BIT_CNT_6_R = crate::FieldReader<u32, u32>;
#[doc = "Field `frame_bit_cnt_6` writer - "]
pub type FRAME_BIT_CNT_6_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, MJPEG_BIT_CNT6_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn frame_bit_cnt_6(&mut self) -> FRAME_BIT_CNT_6_W<0> {
        FRAME_BIT_CNT_6_W::new(self)
    }
