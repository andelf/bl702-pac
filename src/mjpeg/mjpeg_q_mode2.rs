...
pub type FRAME_Q_MODE_2_R = crate::FieldReader<u8, u8>;
#[doc = "Field `frame_q_mode_2` writer - "]
pub type FRAME_Q_MODE_2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, MJPEG_Q_MODE2_SPEC, u8, u8, 7, O>;
impl R {
    #[doc = "Bits 0:6"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn frame_q_mode_2(&mut self) -> FRAME_Q_MODE_2_W<0> {
        FRAME_Q_MODE_2_W::new(self)
    }
