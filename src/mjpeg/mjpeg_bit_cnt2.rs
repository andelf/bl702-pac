...
pub struct FRAME_BIT_CNT_2_R(crate::FieldReader<u32, u32>);
impl FRAME_BIT_CNT_2_R {
    pub(crate) fn new(bits: u32) -> Self {
        FRAME_BIT_CNT_2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FRAME_BIT_CNT_2_R {
...
pub struct FRAME_BIT_CNT_2_W<'a> {
    w: &'a mut W,
}
impl<'a> FRAME_BIT_CNT_2_W<'a> {
...
impl R {
    ...
    pub fn frame_bit_cnt_2(&self) -> FRAME_BIT_CNT_2_R {
        FRAME_BIT_CNT_2_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn frame_bit_cnt_2(&mut self) -> FRAME_BIT_CNT_2_W {
        FRAME_BIT_CNT_2_W { w: self }
    }
