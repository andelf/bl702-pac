...
pub struct FRAME_START_ADDR_4_R(crate::FieldReader<u32, u32>);
impl FRAME_START_ADDR_4_R {
    pub(crate) fn new(bits: u32) -> Self {
        FRAME_START_ADDR_4_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FRAME_START_ADDR_4_R {
...
pub struct FRAME_START_ADDR_4_W<'a> {
    w: &'a mut W,
}
impl<'a> FRAME_START_ADDR_4_W<'a> {
...
impl R {
    ...
    pub fn frame_start_addr_4(&self) -> FRAME_START_ADDR_4_R {
        FRAME_START_ADDR_4_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn frame_start_addr_4(&mut self) -> FRAME_START_ADDR_4_W {
        FRAME_START_ADDR_4_W { w: self }
    }
