...
pub struct FRAME_Q_MODE_5_R(crate::FieldReader<u8, u8>);
impl FRAME_Q_MODE_5_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        FRAME_Q_MODE_5_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FRAME_Q_MODE_5_R {
...
pub struct FRAME_Q_MODE_5_W<'a> {
    w: &'a mut W,
}
impl<'a> FRAME_Q_MODE_5_W<'a> {
...
impl W {
    #[doc = "Bits 0:6"]
    #[inline(always)]
    pub fn frame_q_mode_5(&mut self) -> FRAME_Q_MODE_5_W {
        FRAME_Q_MODE_5_W { w: self }
    }
