...
pub type FRAME_START_ADDR_B_R = crate::FieldReader<u32, u32>;
#[doc = "Field `frame_start_addr_b` writer - "]
pub type FRAME_START_ADDR_B_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, MJPEG_START_ADDR_B_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn frame_start_addr_b(&self) -> FRAME_START_ADDR_B_R {
        FRAME_START_ADDR_B_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    #[must_use]
    pub fn frame_start_addr_b(&mut self) -> FRAME_START_ADDR_B_W<0> {
        FRAME_START_ADDR_B_W::new(self)
    }
