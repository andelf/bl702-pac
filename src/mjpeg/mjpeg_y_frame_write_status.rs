...
pub struct YY_FRM_CNT_W_R(crate::FieldReader<u8, u8>);
impl YY_FRM_CNT_W_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        YY_FRM_CNT_W_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for YY_FRM_CNT_W_R {
...
pub struct YY_FRM_CNT_W_W<'a> {
    w: &'a mut W,
}
impl<'a> YY_FRM_CNT_W_W<'a> {
...
pub struct YY_MEM_RND_W_R(crate::FieldReader<u8, u8>);
impl YY_MEM_RND_W_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        YY_MEM_RND_W_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for YY_MEM_RND_W_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct YY_MEM_RND_W_W<'a> {
    w: &'a mut W,
}
impl<'a> YY_MEM_RND_W_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
pub struct YY_MEM_HBLK_W_R(crate::FieldReader<u16, u16>);
impl YY_MEM_HBLK_W_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        YY_MEM_HBLK_W_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for YY_MEM_HBLK_W_R {
...
pub struct YY_MEM_HBLK_W_W<'a> {
    w: &'a mut W,
}
impl<'a> YY_MEM_HBLK_W_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 24:31"]
    #[inline(always)]
    pub fn yy_frm_cnt_w(&mut self) -> YY_FRM_CNT_W_W {
        YY_FRM_CNT_W_W { w: self }
    }
    #[doc = "Bits 16:23"]
    #[inline(always)]
    pub fn yy_mem_rnd_w(&mut self) -> YY_MEM_RND_W_W {
        YY_MEM_RND_W_W { w: self }
    }
    #[doc = "Bits 0:12"]
    #[inline(always)]
    pub fn yy_mem_hblk_w(&mut self) -> YY_MEM_HBLK_W_W {
        YY_MEM_HBLK_W_W { w: self }
    }
