...
pub struct FRAME_Q_MODE_D_R(crate::FieldReader<u8, u8>);
impl FRAME_Q_MODE_D_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        FRAME_Q_MODE_D_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FRAME_Q_MODE_D_R {
...
pub struct FRAME_Q_MODE_D_W<'a> {
    w: &'a mut W,
}
impl<'a> FRAME_Q_MODE_D_W<'a> {
...
impl W {
    #[doc = "Bits 0:6"]
    #[inline(always)]
    pub fn frame_q_mode_d(&mut self) -> FRAME_Q_MODE_D_W {
        FRAME_Q_MODE_D_W { w: self }
    }
