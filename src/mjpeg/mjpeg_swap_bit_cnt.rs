...
pub struct FRAME_SWAP_END_BIT_CNT_R(crate::FieldReader<u32, u32>);
impl FRAME_SWAP_END_BIT_CNT_R {
    pub(crate) fn new(bits: u32) -> Self {
        FRAME_SWAP_END_BIT_CNT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FRAME_SWAP_END_BIT_CNT_R {
...
pub struct FRAME_SWAP_END_BIT_CNT_W<'a> {
    w: &'a mut W,
}
impl<'a> FRAME_SWAP_END_BIT_CNT_W<'a> {
...
impl R {
    ...
    pub fn frame_swap_end_bit_cnt(&self) -> FRAME_SWAP_END_BIT_CNT_R {
        FRAME_SWAP_END_BIT_CNT_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn frame_swap_end_bit_cnt(&mut self) -> FRAME_SWAP_END_BIT_CNT_W {
        FRAME_SWAP_END_BIT_CNT_W { w: self }
    }
