...
pub struct REG_ADDR_START_1_R(crate::FieldReader<u32, u32>);
impl REG_ADDR_START_1_R {
    pub(crate) fn new(bits: u32) -> Self {
        REG_ADDR_START_1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for REG_ADDR_START_1_R {
...
pub struct REG_ADDR_START_1_W<'a> {
    w: &'a mut W,
}
impl<'a> REG_ADDR_START_1_W<'a> {
...
impl R {
    ...
    pub fn reg_addr_start_1(&self) -> REG_ADDR_START_1_R {
        REG_ADDR_START_1_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn reg_addr_start_1(&mut self) -> REG_ADDR_START_1_W {
        REG_ADDR_START_1_W { w: self }
    }
