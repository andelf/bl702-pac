...
pub type FRAME_BYTE_CNT_0_1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `frame_byte_cnt_0_1` writer - "]
pub type FRAME_BYTE_CNT_0_1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FRAME_BYTE_CNT0_1_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn frame_byte_cnt_0_1(&self) -> FRAME_BYTE_CNT_0_1_R {
        FRAME_BYTE_CNT_0_1_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    #[must_use]
    pub fn frame_byte_cnt_0_1(&mut self) -> FRAME_BYTE_CNT_0_1_W<0> {
        FRAME_BYTE_CNT_0_1_W::new(self)
    }
