#[doc = "Register `frame_byte_cnt0_3` reader"]
...
impl From<crate::W<FRAME_BYTE_CNT0_3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FRAME_BYTE_CNT0_3_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `frame_byte_cnt_0_3` reader - "]
pub type FRAME_BYTE_CNT_0_3_R = crate::FieldReader<u32, u32>;
#[doc = "Field `frame_byte_cnt_0_3` writer - "]
pub type FRAME_BYTE_CNT_0_3_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FRAME_BYTE_CNT0_3_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn frame_byte_cnt_0_3(&mut self) -> FRAME_BYTE_CNT_0_3_W<0> {
        FRAME_BYTE_CNT_0_3_W::new(self)
    }
