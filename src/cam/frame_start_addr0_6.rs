...
pub type FRAME_START_ADDR_0_6_R = crate::FieldReader<u32, u32>;
#[doc = "Field `frame_start_addr_0_6` writer - "]
pub type FRAME_START_ADDR_0_6_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FRAME_START_ADDR0_6_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn frame_start_addr_0_6(&mut self) -> FRAME_START_ADDR_0_6_W<0> {
        FRAME_START_ADDR_0_6_W::new(self)
    }
