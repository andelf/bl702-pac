...
pub struct REG_HSYNC_ACT_START_R(crate::FieldReader<u16, u16>);
impl REG_HSYNC_ACT_START_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        REG_HSYNC_ACT_START_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for REG_HSYNC_ACT_START_R {
...
pub struct REG_HSYNC_ACT_START_W<'a> {
    w: &'a mut W,
}
impl<'a> REG_HSYNC_ACT_START_W<'a> {
...
pub struct REG_HSYNC_ACT_END_R(crate::FieldReader<u16, u16>);
impl REG_HSYNC_ACT_END_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        REG_HSYNC_ACT_END_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for REG_HSYNC_ACT_END_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct REG_HSYNC_ACT_END_W<'a> {
    w: &'a mut W,
}
impl<'a> REG_HSYNC_ACT_END_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u16) -> &'a mut W {
...
impl W {
    #[doc = "Bits 16:31"]
    #[inline(always)]
    pub fn reg_hsync_act_start(&mut self) -> REG_HSYNC_ACT_START_W {
        REG_HSYNC_ACT_START_W { w: self }
    }
    #[doc = "Bits 0:15"]
    #[inline(always)]
    pub fn reg_hsync_act_end(&mut self) -> REG_HSYNC_ACT_END_W {
        REG_HSYNC_ACT_END_W { w: self }
    }
