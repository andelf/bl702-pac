#[doc = "Register `frame_byte_cnt0_5` reader"]
...
pub type FRAME_BYTE_CNT_0_5_R = crate::FieldReader<u32, u32>;
#[doc = "Field `frame_byte_cnt_0_5` writer - "]
pub type FRAME_BYTE_CNT_0_5_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FRAME_BYTE_CNT0_5_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn frame_byte_cnt_0_5(&mut self) -> FRAME_BYTE_CNT_0_5_W<0> {
        FRAME_BYTE_CNT_0_5_W::new(self)
    }
