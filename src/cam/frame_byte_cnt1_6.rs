...
pub type FRAME_BYTE_CNT_1_6_R = crate::FieldReader<u32, u32>;
#[doc = "Field `frame_byte_cnt_1_6` writer - "]
pub type FRAME_BYTE_CNT_1_6_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FRAME_BYTE_CNT1_6_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn frame_byte_cnt_1_6(&mut self) -> FRAME_BYTE_CNT_1_6_W<0> {
        FRAME_BYTE_CNT_1_6_W::new(self)
    }
