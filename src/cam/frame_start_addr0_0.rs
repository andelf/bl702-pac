...
pub struct FRAME_START_ADDR_0_0_R(crate::FieldReader<u32, u32>);
impl FRAME_START_ADDR_0_0_R {
    pub(crate) fn new(bits: u32) -> Self {
        FRAME_START_ADDR_0_0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FRAME_START_ADDR_0_0_R {
...
pub struct FRAME_START_ADDR_0_0_W<'a> {
    w: &'a mut W,
}
impl<'a> FRAME_START_ADDR_0_0_W<'a> {
...
impl R {
    ...
    pub fn frame_start_addr_0_0(&self) -> FRAME_START_ADDR_0_0_R {
        FRAME_START_ADDR_0_0_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn frame_start_addr_0_0(&mut self) -> FRAME_START_ADDR_0_0_W {
        FRAME_START_ADDR_0_0_W { w: self }
    }
