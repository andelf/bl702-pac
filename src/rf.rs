...
pub struct RegisterBlock {
    ...
    pub non_reg_readback: NON_REG_READBACK,
    #[doc = "0x120 - Register control of TX/RX gain"]
    pub trx_gain_bw: TRX_GAIN_BW,
    #[doc = "0x124 - Hardware read back of TX/RX gain"]
    pub trx_gain_bw_hw: TRX_GAIN_BW_HW,
    #[doc = "0x128 - DC Test register 0"]
    pub dctest_actest: DCTEST_ACTEST,
    #[doc = "0x12c - LO Bias Mode registers"]
    pub dtest: DTEST,
    #[doc = "0x130 - adpll_test."]
    pub adpll_test: ADPLL_TEST,
    #[doc = "0x134 - rf_ext_pa."]
    pub rf_ext_pa: RF_EXT_PA,
    _reserved21: [u8; 0xc8],
    #[doc = "0x200 - cip_ldo15."]
    pub cip_ldo15: CIP_LDO15,
    #[doc = "0x204 - PA register"]
    pub pa: PA,
    #[doc = "0x208 - LNA mixer register"]
    pub lna_mx: LNA_MX,
    #[doc = "0x20c - rbb_rosdac."]
    pub rbb_rosdac: RBB_ROSDAC,
    #[doc = "0x210 - rbb_cap_1."]
    pub rbb_cap_1: RBB_CAP_1,
    #[doc = "0x214 - rbb_cap_2."]
    pub rbb_cap_2: RBB_CAP_2,
    #[doc = "0x218 - rbb_cap_3."]
    pub rbb_cap_3: RBB_CAP_3,
    #[doc = "0x21c - rbb_cap4."]
    pub rbb_cap4: RBB_CAP4,
    #[doc = "0x220 - rbb_rx."]
    pub rbb_rx: RBB_RX,
    #[doc = "0x224 - rbb."]
    pub rbb: RBB,
    ...
    pub rxadc_readback: RXADC_READBACK,
    #[doc = "0x230 - rf_adc_osdata."]
    pub rf_adc_osdata: RF_ADC_OSDATA,
    #[doc = "0x234 - testbuf."]
    pub testbuf: TESTBUF,
    #[doc = "0x238 - vco."]
    pub vco: VCO,
    ...
    pub adpll_slope_gen: ADPLL_SLOPE_GEN,
    #[doc = "0x250 - adpll_adc."]
    pub adpll_adc: ADPLL_ADC,
    #[doc = "0x254 - adpll_dtc."]
    pub adpll_dtc: ADPLL_DTC,
    #[doc = "0x258 - lo_fc_config1."]
    pub lo_fc_config1: LO_FC_CONFIG1,
    #[doc = "0x25c - lo_fcw_config2."]
    pub lo_fcw_config2: LO_FCW_CONFIG2,
    #[doc = "0x260 - lo_fcw3."]
    pub lo_fcw3: LO_FCW3,
    #[doc = "0x264 - lotpm."]
    pub lotpm: LOTPM,
    ...
    pub adpll_lf_reg: ADPLL_LF_REG,
    #[doc = "0x270 - adpll_lf_tx."]
    pub adpll_lf_tx: ADPLL_LF_TX,
    #[doc = "0x274 - adpll_lf_rx."]
    pub adpll_lf_rx: ADPLL_LF_RX,
    #[doc = "0x278 - adpll_lf_hw."]
    pub adpll_lf_hw: ADPLL_LF_HW,
    #[doc = "0x27c - adpll_vctrl."]
    pub adpll_vctrl: ADPLL_VCTRL,
    #[doc = "0x280 - adpll_lms."]
    pub adpll_lms: ADPLL_LMS,
    #[doc = "0x284 - adpll_spd."]
    pub adpll_spd: ADPLL_SPD,
    #[doc = "0x288 - fcal."]
    pub fcal: FCAL,
    #[doc = "0x28c - adpll_polarity."]
    pub adpll_polarity: ADPLL_POLARITY,
    #[doc = "0x290 - adpll_output."]
    pub adpll_output: ADPLL_OUTPUT,
    #[doc = "0x294 - adpll_reserved."]
    pub adpll_reserved: ADPLL_RESERVED,
    #[doc = "0x298 - rf_reserved."]
    pub rf_reserved: RF_RESERVED,
    #[doc = "0x29c - rf_reserved_2."]
    pub rf_reserved_2: RF_RESERVED_2,
    _reserved61: [u8; 0x60],
    #[doc = "0x300 - rbb_gain_ctrl0."]
    pub rbb_gain_ctrl0: RBB_GAIN_CTRL0,
    #[doc = "0x304 - rbb_gain_ctrl1."]
    pub rbb_gain_ctrl1: RBB_GAIN_CTRL1,
    #[doc = "0x308 - rbb_gain_ctrl2."]
    pub rbb_gain_ctrl2: RBB_GAIN_CTRL2,
    #[doc = "0x30c - rbb_gain_ctrl3."]
    pub rbb_gain_ctrl3: RBB_GAIN_CTRL3,
    #[doc = "0x310 - rbb_gain_ctrl4."]
    pub rbb_gain_ctrl4: RBB_GAIN_CTRL4,
    #[doc = "0x314 - rbb_gain_ctrl5."]
    pub rbb_gain_ctrl5: RBB_GAIN_CTRL5,
    #[doc = "0x318 - rbb_gain_ctrl6."]
    pub rbb_gain_ctrl6: RBB_GAIN_CTRL6,
    #[doc = "0x31c - rbb_gain_ctrl7."]
    pub rbb_gain_ctrl7: RBB_GAIN_CTRL7,
    #[doc = "0x320 - rbb_gain_ctrl8."]
    pub rbb_gain_ctrl8: RBB_GAIN_CTRL8,
    #[doc = "0x324 - rbb_gain_ctrl9."]
    pub rbb_gain_ctrl9: RBB_GAIN_CTRL9,
    #[doc = "0x328 - rbb_gain_ctrl10."]
    pub rbb_gain_ctrl10: RBB_GAIN_CTRL10,
    #[doc = "0x32c - rbb_gain_ctrl11."]
    pub rbb_gain_ctrl11: RBB_GAIN_CTRL11,
    #[doc = "0x330 - rbb_gain_ctrl12."]
    pub rbb_gain_ctrl12: RBB_GAIN_CTRL12,
    #[doc = "0x334 - rbb_gain_ctrl13."]
    pub rbb_gain_ctrl13: RBB_GAIN_CTRL13,
    #[doc = "0x338 - rbb_gain_ctrl14."]
    pub rbb_gain_ctrl14: RBB_GAIN_CTRL14,
    #[doc = "0x33c - rbb_gain_ctrl15."]
    pub rbb_gain_ctrl15: RBB_GAIN_CTRL15,
    _reserved77: [u8; 0xc0],
    #[doc = "0x400 - acal_config."]
    pub acal_config: ACAL_CONFIG,
    #[doc = "0x404 - lo_config_2402."]
    pub lo_config_2402: LO_CONFIG_2402,
    #[doc = "0x408 - lo_config_2404."]
    pub lo_config_2404: LO_CONFIG_2404,
    #[doc = "0x40c - lo_config_2406."]
    pub lo_config_2406: LO_CONFIG_2406,
    #[doc = "0x410 - lo_config_2408."]
    pub lo_config_2408: LO_CONFIG_2408,
    #[doc = "0x414 - lo_config_2410."]
    pub lo_config_2410: LO_CONFIG_2410,
    #[doc = "0x418 - lo_config_2412."]
    pub lo_config_2412: LO_CONFIG_2412,
    #[doc = "0x41c - lo_config_2414."]
    pub lo_config_2414: LO_CONFIG_2414,
    #[doc = "0x420 - lo_config_2416."]
    pub lo_config_2416: LO_CONFIG_2416,
    #[doc = "0x424 - lo_config_2418."]
    pub lo_config_2418: LO_CONFIG_2418,
    #[doc = "0x428 - lo_config_2420."]
    pub lo_config_2420: LO_CONFIG_2420,
    #[doc = "0x42c - lo_config_2422."]
    pub lo_config_2422: LO_CONFIG_2422,
    #[doc = "0x430 - lo_config_2424."]
    pub lo_config_2424: LO_CONFIG_2424,
    #[doc = "0x434 - lo_config_2426."]
    pub lo_config_2426: LO_CONFIG_2426,
    #[doc = "0x438 - lo_config_2428."]
    pub lo_config_2428: LO_CONFIG_2428,
    #[doc = "0x43c - lo_config_2430."]
    pub lo_config_2430: LO_CONFIG_2430,
    #[doc = "0x440 - lo_config_2432."]
    pub lo_config_2432: LO_CONFIG_2432,
    #[doc = "0x444 - lo_config_2434."]
    pub lo_config_2434: LO_CONFIG_2434,
    #[doc = "0x448 - lo_config_2436."]
    pub lo_config_2436: LO_CONFIG_2436,
    #[doc = "0x44c - lo_config_2438."]
    pub lo_config_2438: LO_CONFIG_2438,
    #[doc = "0x450 - lo_config_2440."]
    pub lo_config_2440: LO_CONFIG_2440,
    #[doc = "0x454 - lo_config_2442."]
    pub lo_config_2442: LO_CONFIG_2442,
    #[doc = "0x458 - lo_config_2444."]
    pub lo_config_2444: LO_CONFIG_2444,
    #[doc = "0x45c - lo_config_2446."]
    pub lo_config_2446: LO_CONFIG_2446,
    #[doc = "0x460 - lo_config_2448."]
    pub lo_config_2448: LO_CONFIG_2448,
    #[doc = "0x464 - lo_config_2450."]
    pub lo_config_2450: LO_CONFIG_2450,
    #[doc = "0x468 - lo_config_2452."]
    pub lo_config_2452: LO_CONFIG_2452,
    #[doc = "0x46c - lo_config_2454."]
    pub lo_config_2454: LO_CONFIG_2454,
    #[doc = "0x470 - lo_config_2456."]
    pub lo_config_2456: LO_CONFIG_2456,
    #[doc = "0x474 - lo_config_2458."]
    pub lo_config_2458: LO_CONFIG_2458,
    #[doc = "0x478 - lo_config_2460."]
    pub lo_config_2460: LO_CONFIG_2460,
    #[doc = "0x47c - lo_config_2462."]
    pub lo_config_2462: LO_CONFIG_2462,
    #[doc = "0x480 - lo_config_2464."]
    pub lo_config_2464: LO_CONFIG_2464,
    #[doc = "0x484 - lo_config_2466."]
    pub lo_config_2466: LO_CONFIG_2466,
    #[doc = "0x488 - lo_config_2468."]
    pub lo_config_2468: LO_CONFIG_2468,
    #[doc = "0x48c - lo_config_2470."]
    pub lo_config_2470: LO_CONFIG_2470,
    #[doc = "0x490 - lo_config_2472."]
    pub lo_config_2472: LO_CONFIG_2472,
    #[doc = "0x494 - lo_config_2474."]
    pub lo_config_2474: LO_CONFIG_2474,
    #[doc = "0x498 - lo_config_2476."]
    pub lo_config_2476: LO_CONFIG_2476,
    #[doc = "0x49c - lo_config_2478."]
    pub lo_config_2478: LO_CONFIG_2478,
    #[doc = "0x4a0 - lo_config_2480."]
    pub lo_config_2480: LO_CONFIG_2480,
    #[doc = "0x4a4 - lo_config_2405."]
    pub lo_config_2405: LO_CONFIG_2405,
    #[doc = "0x4a8 - lo_config_2415."]
    pub lo_config_2415: LO_CONFIG_2415,
    #[doc = "0x4ac - lo_config_2425."]
    pub lo_config_2425: LO_CONFIG_2425,
    #[doc = "0x4b0 - lo_config_2435."]
    pub lo_config_2435: LO_CONFIG_2435,
    #[doc = "0x4b4 - lo_config_2445."]
    pub lo_config_2445: LO_CONFIG_2445,
    #[doc = "0x4b8 - lo_config_2455."]
    pub lo_config_2455: LO_CONFIG_2455,
    #[doc = "0x4bc - lo_config_2465."]
    pub lo_config_2465: LO_CONFIG_2465,
    #[doc = "0x4c0 - lo_config_2475."]
    pub lo_config_2475: LO_CONFIG_2475,
    _reserved126: [u8; 0x3c],
    #[doc = "0x500 - dg_testbus_0."]
    pub dg_testbus_0: DG_TESTBUS_0,
    #[doc = "0x504 - dg_testbus_1."]
    pub dg_testbus_1: DG_TESTBUS_1,
    #[doc = "0x508 - dg_ppud_0."]
    pub dg_ppud_0: DG_PPUD_0,
    #[doc = "0x50c - rf_top."]
    pub rf_top: RF_TOP,
    #[doc = "0x510 - rf_fsm."]
    pub rf_fsm: RF_FSM,
    #[doc = "0x514 - rf_singen_0."]
    pub rf_singen_0: RF_SINGEN_0,
    #[doc = "0x518 - rf_singen_1."]
    pub rf_singen_1: RF_SINGEN_1,
    #[doc = "0x51c - rf_singen_2."]
    pub rf_singen_2: RF_SINGEN_2,
    #[doc = "0x520 - rf_singen_3."]
    pub rf_singen_3: RF_SINGEN_3,
    #[doc = "0x524 - rf_singen_4."]
    pub rf_singen_4: RF_SINGEN_4,
    ...
    pub rf_test_mode: RF_TEST_MODE,
    #[doc = "0x538 - rf_rx_pulse_filter."]
    pub rf_rx_pulse_filter: RF_RX_PULSE_FILTER,
}
...
pub mod rf_rev;
#[doc = "dsp_readback (rw) register accessor: an alias for `Reg<DSP_READBACK_SPEC>`"]
pub type DSP_READBACK = crate::Reg<dsp_readback::DSP_READBACK_SPEC>;
#[doc = "dsp_readback."]
pub mod dsp_readback;
#[doc = "rf_ctrl_source (rw) register accessor: an alias for `Reg<RF_CTRL_SOURCE_SPEC>`"]
pub type RF_CTRL_SOURCE = crate::Reg<rf_ctrl_source::RF_CTRL_SOURCE_SPEC>;
#[doc = "Control logic switch"]
pub mod rf_ctrl_source;
#[doc = "rf_cal_state_ctrl (rw) register accessor: an alias for `Reg<RF_CAL_STATE_CTRL_SPEC>`"]
...
#[doc = "rf_cal_switch_ctrl (rw) register accessor: an alias for `Reg<RF_CAL_SWITCH_CTRL_SPEC>`"]
...
#[doc = "dctest_actest (rw) register accessor: an alias for `Reg<DCTEST_ACTEST_SPEC>`"]
pub type DCTEST_ACTEST = crate::Reg<dctest_actest::DCTEST_ACTEST_SPEC>;
#[doc = "DC Test register 0"]
pub mod dctest_actest;
#[doc = "dtest (rw) register accessor: an alias for `Reg<DTEST_SPEC>`"]
pub type DTEST = crate::Reg<dtest::DTEST_SPEC>;
#[doc = "LO Bias Mode registers"]
pub mod dtest;
#[doc = "adpll_test (rw) register accessor: an alias for `Reg<ADPLL_TEST_SPEC>`"]
pub type ADPLL_TEST = crate::Reg<adpll_test::ADPLL_TEST_SPEC>;
#[doc = "adpll_test."]
pub mod adpll_test;
#[doc = "rf_ext_pa (rw) register accessor: an alias for `Reg<RF_EXT_PA_SPEC>`"]
pub type RF_EXT_PA = crate::Reg<rf_ext_pa::RF_EXT_PA_SPEC>;
#[doc = "rf_ext_pa."]
pub mod rf_ext_pa;
#[doc = "cip_ldo15 (rw) register accessor: an alias for `Reg<CIP_LDO15_SPEC>`"]
pub type CIP_LDO15 = crate::Reg<cip_ldo15::CIP_LDO15_SPEC>;
#[doc = "cip_ldo15."]
pub mod cip_ldo15;
#[doc = "pa (rw) register accessor: an alias for `Reg<PA_SPEC>`"]
pub type PA = crate::Reg<pa::PA_SPEC>;
#[doc = "PA register"]
pub mod pa;
#[doc = "lna_mx (rw) register accessor: an alias for `Reg<LNA_MX_SPEC>`"]
pub type LNA_MX = crate::Reg<lna_mx::LNA_MX_SPEC>;
#[doc = "LNA mixer register"]
pub mod lna_mx;
#[doc = "rbb_rosdac (rw) register accessor: an alias for `Reg<RBB_ROSDAC_SPEC>`"]
pub type RBB_ROSDAC = crate::Reg<rbb_rosdac::RBB_ROSDAC_SPEC>;
#[doc = "rbb_rosdac."]
pub mod rbb_rosdac;
#[doc = "rbb_cap_1 (rw) register accessor: an alias for `Reg<RBB_CAP_1_SPEC>`"]
pub type RBB_CAP_1 = crate::Reg<rbb_cap_1::RBB_CAP_1_SPEC>;
#[doc = "rbb_cap_1."]
pub mod rbb_cap_1;
#[doc = "rbb_cap_2 (rw) register accessor: an alias for `Reg<RBB_CAP_2_SPEC>`"]
pub type RBB_CAP_2 = crate::Reg<rbb_cap_2::RBB_CAP_2_SPEC>;
#[doc = "rbb_cap_2."]
pub mod rbb_cap_2;
#[doc = "rbb_cap_3 (rw) register accessor: an alias for `Reg<RBB_CAP_3_SPEC>`"]
pub type RBB_CAP_3 = crate::Reg<rbb_cap_3::RBB_CAP_3_SPEC>;
#[doc = "rbb_cap_3."]
pub mod rbb_cap_3;
#[doc = "rbb_cap4 (rw) register accessor: an alias for `Reg<RBB_CAP4_SPEC>`"]
pub type RBB_CAP4 = crate::Reg<rbb_cap4::RBB_CAP4_SPEC>;
#[doc = "rbb_cap4."]
pub mod rbb_cap4;
#[doc = "rbb_rx (rw) register accessor: an alias for `Reg<RBB_RX_SPEC>`"]
pub type RBB_RX = crate::Reg<rbb_rx::RBB_RX_SPEC>;
#[doc = "rbb_rx."]
pub mod rbb_rx;
#[doc = "rbb (rw) register accessor: an alias for `Reg<RBB_SPEC>`"]
pub type RBB = crate::Reg<rbb::RBB_SPEC>;
#[doc = "rbb."]
pub mod rbb;
#[doc = "rxadc (rw) register accessor: an alias for `Reg<RXADC_SPEC>`"]
pub type RXADC = crate::Reg<rxadc::RXADC_SPEC>;
#[doc = "rxadc."]
pub mod rxadc;
#[doc = "rxadc_readback (rw) register accessor: an alias for `Reg<RXADC_READBACK_SPEC>`"]
pub type RXADC_READBACK = crate::Reg<rxadc_readback::RXADC_READBACK_SPEC>;
#[doc = "rxadc_readback."]
pub mod rxadc_readback;
#[doc = "rf_adc_osdata (rw) register accessor: an alias for `Reg<RF_ADC_OSDATA_SPEC>`"]
pub type RF_ADC_OSDATA = crate::Reg<rf_adc_osdata::RF_ADC_OSDATA_SPEC>;
#[doc = "rf_adc_osdata."]
pub mod rf_adc_osdata;
#[doc = "testbuf (rw) register accessor: an alias for `Reg<TESTBUF_SPEC>`"]
pub type TESTBUF = crate::Reg<testbuf::TESTBUF_SPEC>;
#[doc = "testbuf."]
pub mod testbuf;
#[doc = "vco (rw) register accessor: an alias for `Reg<VCO_SPEC>`"]
...
#[doc = "rf_test_mode (rw) register accessor: an alias for `Reg<RF_TEST_MODE_SPEC>`"]
pub type RF_TEST_MODE = crate::Reg<rf_test_mode::RF_TEST_MODE_SPEC>;
#[doc = "rf_test_mode."]
pub mod rf_test_mode;
#[doc = "rf_rx_pulse_filter (rw) register accessor: an alias for `Reg<RF_RX_PULSE_FILTER_SPEC>`"]
