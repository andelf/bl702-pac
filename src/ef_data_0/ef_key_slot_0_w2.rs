#[doc = "Register `ef_key_slot_0_w2` reader"]
...
pub type EF_KEY_SLOT_0_W2_R = crate::FieldReader<u32, u32>;
#[doc = "Field `ef_key_slot_0_w2` writer - "]
pub type EF_KEY_SLOT_0_W2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, EF_KEY_SLOT_0_W2_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn ef_key_slot_0_w2(&mut self) -> EF_KEY_SLOT_0_W2_W<0> {
        EF_KEY_SLOT_0_W2_W::new(self)
    }
