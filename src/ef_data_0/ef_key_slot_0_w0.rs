...
pub struct EF_KEY_SLOT_0_W0_R(crate::FieldReader<u32, u32>);
impl EF_KEY_SLOT_0_W0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        EF_KEY_SLOT_0_W0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EF_KEY_SLOT_0_W0_R {
...
pub struct EF_KEY_SLOT_0_W0_W<'a> {
    w: &'a mut W,
}
impl<'a> EF_KEY_SLOT_0_W0_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn ef_key_slot_0_w0(&mut self) -> EF_KEY_SLOT_0_W0_W {
        EF_KEY_SLOT_0_W0_W { w: self }
    }
