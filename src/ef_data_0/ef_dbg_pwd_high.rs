...
pub type EF_DBG_PWD_HIGH_R = crate::FieldReader<u32, u32>;
#[doc = "Field `ef_dbg_pwd_high` writer - "]
pub type EF_DBG_PWD_HIGH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, EF_DBG_PWD_HIGH_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn ef_dbg_pwd_high(&mut self) -> EF_DBG_PWD_HIGH_W<0> {
        EF_DBG_PWD_HIGH_W::new(self)
    }
