...
pub type EF_SF_KEY_0_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ef_sf_key_0_sel` writer - "]
pub type EF_SF_KEY_0_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, EF_CFG_0_SPEC, u8, u8, 2, O>;
...
impl R {
    ...
    pub fn ef_sf_key_0_sel(&self) -> EF_SF_KEY_0_SEL_R {
        EF_SF_KEY_0_SEL_R::new(((self.bits >> 12) & 3) as u8)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ef_sf_key_0_sel(&mut self) -> EF_SF_KEY_0_SEL_W<12> {
        EF_SF_KEY_0_SEL_W::new(self)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    #[must_use]
