...
pub type EF_KEY_SLOT_3_W0_R = crate::FieldReader<u32, u32>;
#[doc = "Field `ef_key_slot_3_w0` writer - "]
pub type EF_KEY_SLOT_3_W0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, EF_KEY_SLOT_3_W0_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn ef_key_slot_3_w0(&self) -> EF_KEY_SLOT_3_W0_R {
        EF_KEY_SLOT_3_W0_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn ef_key_slot_3_w0(&mut self) -> EF_KEY_SLOT_3_W0_W<0> {
        EF_KEY_SLOT_3_W0_W::new(self)
    }
