...
pub type EF_WIFI_MAC_LOW_R = crate::FieldReader<u32, u32>;
#[doc = "Field `ef_wifi_mac_low` writer - "]
pub type EF_WIFI_MAC_LOW_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, EF_WIFI_MAC_LOW_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn ef_wifi_mac_low(&self) -> EF_WIFI_MAC_LOW_R {
        EF_WIFI_MAC_LOW_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn ef_wifi_mac_low(&mut self) -> EF_WIFI_MAC_LOW_W<0> {
        EF_WIFI_MAC_LOW_W::new(self)
    }
