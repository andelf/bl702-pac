...
pub struct EF_IF_SF_KEY_0_SEL_R(crate::FieldReader<u8, u8>);
impl EF_IF_SF_KEY_0_SEL_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        EF_IF_SF_KEY_0_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EF_IF_SF_KEY_0_SEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct EF_IF_SF_KEY_0_SEL_W<'a> {
    w: &'a mut W,
}
impl<'a> EF_IF_SF_KEY_0_SEL_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl R {
    ...
    pub fn ef_if_sf_key_0_sel(&self) -> EF_IF_SF_KEY_0_SEL_R {
        EF_IF_SF_KEY_0_SEL_R::new(((self.bits >> 12) & 0x03) as u8)
    }
    #[doc = "Bits 8:11"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bits 12:13"]
    #[inline(always)]
    pub fn ef_if_sf_key_0_sel(&mut self) -> EF_IF_SF_KEY_0_SEL_W {
        EF_IF_SF_KEY_0_SEL_W { w: self }
    }
    #[doc = "Bits 8:11"]
    #[inline(always)]
