...
pub type EF_IF_SF_AES_MODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, EF_IF_CFG_0_SPEC, u8, u8, 2, O>;
...
pub type EF_IF_CPU_RST_DBG_DIS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EF_IF_CFG_0_SPEC, bool, O>;
#[doc = "Field `ef_if_se_dbg_dis` reader - "]
pub type EF_IF_SE_DBG_DIS_R = crate::BitReader<bool>;
#[doc = "Field `ef_if_se_dbg_dis` writer - "]
pub type EF_IF_SE_DBG_DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, EF_IF_CFG_0_SPEC, bool, O>;
...
pub type EF_IF_EFUSE_DBG_DIS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EF_IF_CFG_0_SPEC, bool, O>;
...
pub type EF_IF_DBG_JTAG_1_DIS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, EF_IF_CFG_0_SPEC, u8, u8, 2, O>;
...
impl R {
    ...
    #[doc = "Bits 12:13"]
    #[inline(always)]
    pub fn ef_if_sf_key_0_sel(&self) -> EF_IF_SF_KEY_0_SEL_R {
        EF_IF_SF_KEY_0_SEL_R::new(((self.bits >> 12) & 3) as u8)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
