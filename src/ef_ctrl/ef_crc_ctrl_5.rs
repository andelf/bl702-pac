...
pub type EF_CRC_DOUT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, EF_CRC_CTRL_5_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn ef_crc_dout(&mut self) -> EF_CRC_DOUT_W<0> {
        EF_CRC_DOUT_W::new(self)
    }
