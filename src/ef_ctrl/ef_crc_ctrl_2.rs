...
pub struct EF_CRC_DATA_1_EN_R(crate::FieldReader<u32, u32>);
impl EF_CRC_DATA_1_EN_R {
    pub(crate) fn new(bits: u32) -> Self {
        EF_CRC_DATA_1_EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EF_CRC_DATA_1_EN_R {
...
pub struct EF_CRC_DATA_1_EN_W<'a> {
    w: &'a mut W,
}
impl<'a> EF_CRC_DATA_1_EN_W<'a> {
...
impl R {
    ...
    pub fn ef_crc_data_1_en(&self) -> EF_CRC_DATA_1_EN_R {
        EF_CRC_DATA_1_EN_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn ef_crc_data_1_en(&mut self) -> EF_CRC_DATA_1_EN_W {
        EF_CRC_DATA_1_EN_W { w: self }
    }
