...
pub type EF_CRC_DATA_0_EN_R = crate::FieldReader<u32, u32>;
#[doc = "Field `ef_crc_data_0_en` writer - "]
pub type EF_CRC_DATA_0_EN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, EF_CRC_CTRL_1_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ef_crc_data_0_en(&mut self) -> EF_CRC_DATA_0_EN_W<0> {
        EF_CRC_DATA_0_EN_W::new(self)
    }
