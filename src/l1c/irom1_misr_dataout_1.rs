...
pub struct IROM1_MISR_DATAOUT_1_R(crate::FieldReader<u32, u32>);
impl IROM1_MISR_DATAOUT_1_R {
    pub(crate) fn new(bits: u32) -> Self {
        IROM1_MISR_DATAOUT_1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IROM1_MISR_DATAOUT_1_R {
...
pub struct IROM1_MISR_DATAOUT_1_W<'a> {
    w: &'a mut W,
}
impl<'a> IROM1_MISR_DATAOUT_1_W<'a> {
...
impl R {
    ...
    pub fn irom1_misr_dataout_1(&self) -> IROM1_MISR_DATAOUT_1_R {
        IROM1_MISR_DATAOUT_1_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn irom1_misr_dataout_1(&mut self) -> IROM1_MISR_DATAOUT_1_W {
        IROM1_MISR_DATAOUT_1_W { w: self }
    }
