...
pub type ACOMP1_OUT_RAW_W<'a, const O: u8> = crate::BitWriter<'a, u32, ACOMP_CTRL_SPEC, bool, O>;
#[doc = "Field `acomp0_out_raw` reader - "]
pub type ACOMP0_OUT_RAW_R = crate::BitReader<bool>;
#[doc = "Field `acomp0_out_raw` writer - "]
pub type ACOMP0_OUT_RAW_W<'a, const O: u8> = crate::BitWriter<'a, u32, ACOMP_CTRL_SPEC, bool, O>;
