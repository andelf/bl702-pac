...
impl core::ops::Deref for RF_TESTBUS_SEL_R {
...
pub struct RF_TESTBUS_SEL_W<'a> {
    w: &'a mut W,
}
impl<'a> RF_TESTBUS_SEL_W<'a> {
...
impl W {
    #[doc = "Bits 0:3"]
    #[inline(always)]
    pub fn rf_testbus_sel(&mut self) -> RF_TESTBUS_SEL_W {
        RF_TESTBUS_SEL_W { w: self }
    }
