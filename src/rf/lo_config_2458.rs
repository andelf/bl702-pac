...
impl core::ops::Deref for ADPLL_SDM_DITHER_EN_2458_R {
...
impl core::ops::Deref for KCAL_RATIO_2458_R {
...
pub struct KCAL_RATIO_2458_W<'a> {
    w: &'a mut W,
}
impl<'a> KCAL_RATIO_2458_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
impl R {
    ...
    pub fn adpll_sdm_dither_en_2458(&self) -> ADPLL_SDM_DITHER_EN_2458_R {
        ADPLL_SDM_DITHER_EN_2458_R::new(((self.bits >> 12) & 0x01) != 0)
    }
    #[doc = "Bits 0:9"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 12"]
    #[inline(always)]
    pub fn adpll_sdm_dither_en_2458(&mut self) -> ADPLL_SDM_DITHER_EN_2458_W {
        ADPLL_SDM_DITHER_EN_2458_W { w: self }
    }
    #[doc = "Bits 0:9"]
    #[inline(always)]
    pub fn kcal_ratio_2458(&mut self) -> KCAL_RATIO_2458_W {
        KCAL_RATIO_2458_W { w: self }
    }
