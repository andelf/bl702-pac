...
pub type ADPLL_LF_F_P3_TX_R = crate::FieldReader<u8, u8>;
#[doc = "Field `adpll_lf_f_p3_tx` writer - "]
pub type ADPLL_LF_F_P3_TX_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ADPLL_LF_TX_SPEC, u8, u8, 2, O>;
#[doc = "Field `adpll_lf_beta_fast_tx` reader - "]
pub type ADPLL_LF_BETA_FAST_TX_R = crate::BitReader<bool>;
#[doc = "Field `adpll_lf_beta_fast_tx` writer - "]
pub type ADPLL_LF_BETA_FAST_TX_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, ADPLL_LF_TX_SPEC, bool, O>;
#[doc = "Field `adpll_lf_beta_exp_tx` reader - "]
pub type ADPLL_LF_BETA_EXP_TX_R = crate::FieldReader<u8, u8>;
#[doc = "Field `adpll_lf_beta_exp_tx` writer - "]
pub type ADPLL_LF_BETA_EXP_TX_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ADPLL_LF_TX_SPEC, u8, u8, 3, O>;
#[doc = "Field `adpll_lf_beta_base_tx` reader - "]
pub type ADPLL_LF_BETA_BASE_TX_R = crate::FieldReader<u8, u8>;
#[doc = "Field `adpll_lf_beta_base_tx` writer - "]
pub type ADPLL_LF_BETA_BASE_TX_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ADPLL_LF_TX_SPEC, u8, u8, 2, O>;
#[doc = "Field `adpll_lf_alpha_fast_tx` reader - "]
pub type ADPLL_LF_ALPHA_FAST_TX_R = crate::FieldReader<u8, u8>;
#[doc = "Field `adpll_lf_alpha_fast_tx` writer - "]
pub type ADPLL_LF_ALPHA_FAST_TX_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ADPLL_LF_TX_SPEC, u8, u8, 2, O>;
#[doc = "Field `adpll_lf_alpha_exp_tx` reader - "]
pub type ADPLL_LF_ALPHA_EXP_TX_R = crate::FieldReader<u8, u8>;
#[doc = "Field `adpll_lf_alpha_exp_tx` writer - "]
pub type ADPLL_LF_ALPHA_EXP_TX_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ADPLL_LF_TX_SPEC, u8, u8, 3, O>;
#[doc = "Field `adpll_lf_alpha_base_tx` reader - "]
pub type ADPLL_LF_ALPHA_BASE_TX_R = crate::BitReader<bool>;
#[doc = "Field `adpll_lf_alpha_base_tx` writer - "]
pub type ADPLL_LF_ALPHA_BASE_TX_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, ADPLL_LF_TX_SPEC, bool, O>;
impl R {
    #[doc = "Bits 10:11"]
    #[inline(always)]
    pub fn adpll_lf_f_p3_tx(&self) -> ADPLL_LF_F_P3_TX_R {
        ADPLL_LF_F_P3_TX_R::new(((self.bits >> 10) & 3) as u8)
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    pub fn adpll_lf_beta_fast_tx(&self) -> ADPLL_LF_BETA_FAST_TX_R {
        ADPLL_LF_BETA_FAST_TX_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bits 14:16"]
    #[inline(always)]
    pub fn adpll_lf_beta_exp_tx(&self) -> ADPLL_LF_BETA_EXP_TX_R {
        ADPLL_LF_BETA_EXP_TX_R::new(((self.bits >> 14) & 7) as u8)
    }
    #[doc = "Bits 17:18"]
    #[inline(always)]
    pub fn adpll_lf_beta_base_tx(&self) -> ADPLL_LF_BETA_BASE_TX_R {
        ADPLL_LF_BETA_BASE_TX_R::new(((self.bits >> 17) & 3) as u8)
    }
    #[doc = "Bits 20:21"]
    #[inline(always)]
    pub fn adpll_lf_alpha_fast_tx(&self) -> ADPLL_LF_ALPHA_FAST_TX_R {
        ADPLL_LF_ALPHA_FAST_TX_R::new(((self.bits >> 20) & 3) as u8)
    }
    #[doc = "Bits 24:26"]
    #[inline(always)]
    pub fn adpll_lf_alpha_exp_tx(&self) -> ADPLL_LF_ALPHA_EXP_TX_R {
        ADPLL_LF_ALPHA_EXP_TX_R::new(((self.bits >> 24) & 7) as u8)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    pub fn adpll_lf_alpha_base_tx(&self) -> ADPLL_LF_ALPHA_BASE_TX_R {
        ADPLL_LF_ALPHA_BASE_TX_R::new(((self.bits >> 27) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 10:11"]
