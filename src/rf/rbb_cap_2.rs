...
pub struct RBB_CAP1_FC_I_HW_R(crate::FieldReader<u8, u8>);
impl RBB_CAP1_FC_I_HW_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        RBB_CAP1_FC_I_HW_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RBB_CAP1_FC_I_HW_R {
...
pub struct RBB_CAP1_FC_I_HW_W<'a> {
    w: &'a mut W,
}
impl<'a> RBB_CAP1_FC_I_HW_W<'a> {
...
pub struct RBB_CAP1_FC_Q_HW_R(crate::FieldReader<u8, u8>);
impl RBB_CAP1_FC_Q_HW_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        RBB_CAP1_FC_Q_HW_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RBB_CAP1_FC_Q_HW_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct RBB_CAP1_FC_Q_HW_W<'a> {
    w: &'a mut W,
}
impl<'a> RBB_CAP1_FC_Q_HW_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
pub struct RBB_CAP2_FC_I_HW_R(crate::FieldReader<u8, u8>);
impl RBB_CAP2_FC_I_HW_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        RBB_CAP2_FC_I_HW_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RBB_CAP2_FC_I_HW_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct RBB_CAP2_FC_I_HW_W<'a> {
    w: &'a mut W,
}
impl<'a> RBB_CAP2_FC_I_HW_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
pub struct RBB_CAP2_FC_Q_HW_R(crate::FieldReader<u8, u8>);
impl RBB_CAP2_FC_Q_HW_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        RBB_CAP2_FC_Q_HW_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RBB_CAP2_FC_Q_HW_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct RBB_CAP2_FC_Q_HW_W<'a> {
    w: &'a mut W,
}
impl<'a> RBB_CAP2_FC_Q_HW_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl W {
    #[doc = "Bits 24:29"]
    #[inline(always)]
    pub fn rbb_cap1_fc_i_hw(&mut self) -> RBB_CAP1_FC_I_HW_W {
        RBB_CAP1_FC_I_HW_W { w: self }
    }
    #[doc = "Bits 16:21"]
    #[inline(always)]
    pub fn rbb_cap1_fc_q_hw(&mut self) -> RBB_CAP1_FC_Q_HW_W {
        RBB_CAP1_FC_Q_HW_W { w: self }
    }
    #[doc = "Bits 8:13"]
    #[inline(always)]
    pub fn rbb_cap2_fc_i_hw(&mut self) -> RBB_CAP2_FC_I_HW_W {
        RBB_CAP2_FC_I_HW_W { w: self }
    }
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn rbb_cap2_fc_q_hw(&mut self) -> RBB_CAP2_FC_Q_HW_W {
        RBB_CAP2_FC_Q_HW_W { w: self }
    }
