...
pub struct RF_RESV_R(crate::FieldReader<u32, u32>);
impl RF_RESV_R {
    pub(crate) fn new(bits: u32) -> Self {
        RF_RESV_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RF_RESV_R {
...
impl R {
    ...
    pub fn rf_resv(&self) -> RF_RESV_R {
        RF_RESV_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn rf_resv(&mut self) -> RF_RESV_W {
        RF_RESV_W { w: self }
    }
