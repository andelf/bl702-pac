...
pub struct ADPLL_SDM_DITHER_EN_2432_R(crate::FieldReader<bool, bool>);
impl ADPLL_SDM_DITHER_EN_2432_R {
    pub(crate) fn new(bits: bool) -> Self {
        ADPLL_SDM_DITHER_EN_2432_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ADPLL_SDM_DITHER_EN_2432_R {
...
pub struct ADPLL_SDM_DITHER_EN_2432_W<'a> {
    w: &'a mut W,
}
impl<'a> ADPLL_SDM_DITHER_EN_2432_W<'a> {
...
pub struct KCAL_RATIO_2432_R(crate::FieldReader<u16, u16>);
impl KCAL_RATIO_2432_R {
    pub(crate) fn new(bits: u16) -> Self {
        KCAL_RATIO_2432_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for KCAL_RATIO_2432_R {
...
pub struct KCAL_RATIO_2432_W<'a> {
    w: &'a mut W,
}
impl<'a> KCAL_RATIO_2432_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
impl R {
    ...
    pub fn adpll_sdm_dither_en_2432(&self) -> ADPLL_SDM_DITHER_EN_2432_R {
        ADPLL_SDM_DITHER_EN_2432_R::new(((self.bits >> 12) & 0x01) != 0)
    }
    #[doc = "Bits 0:9"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 12"]
    #[inline(always)]
    pub fn adpll_sdm_dither_en_2432(&mut self) -> ADPLL_SDM_DITHER_EN_2432_W {
        ADPLL_SDM_DITHER_EN_2432_W { w: self }
    }
    #[doc = "Bits 0:9"]
    #[inline(always)]
    pub fn kcal_ratio_2432(&mut self) -> KCAL_RATIO_2432_W {
        KCAL_RATIO_2432_W { w: self }
    }
