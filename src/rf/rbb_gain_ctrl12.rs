...
pub type GAIN_CTRL12_ROSDAC_Q_BW0_R = crate::FieldReader<u8, u8>;
#[doc = "Field `gain_ctrl12_rosdac_q_bw0` writer - "]
pub type GAIN_CTRL12_ROSDAC_Q_BW0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RBB_GAIN_CTRL12_SPEC, u8, u8, 6, O>;
#[doc = "Field `gain_ctrl12_rosdac_i_bw0` reader - "]
pub type GAIN_CTRL12_ROSDAC_I_BW0_R = crate::FieldReader<u8, u8>;
#[doc = "Field `gain_ctrl12_rosdac_i_bw0` writer - "]
pub type GAIN_CTRL12_ROSDAC_I_BW0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RBB_GAIN_CTRL12_SPEC, u8, u8, 6, O>;
#[doc = "Field `gain_ctrl12_rosdac_q_bw1` reader - "]
pub type GAIN_CTRL12_ROSDAC_Q_BW1_R = crate::FieldReader<u8, u8>;
#[doc = "Field `gain_ctrl12_rosdac_q_bw1` writer - "]
pub type GAIN_CTRL12_ROSDAC_Q_BW1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RBB_GAIN_CTRL12_SPEC, u8, u8, 6, O>;
#[doc = "Field `gain_ctrl12_rosdac_i_bw1` reader - "]
pub type GAIN_CTRL12_ROSDAC_I_BW1_R = crate::FieldReader<u8, u8>;
#[doc = "Field `gain_ctrl12_rosdac_i_bw1` writer - "]
pub type GAIN_CTRL12_ROSDAC_I_BW1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RBB_GAIN_CTRL12_SPEC, u8, u8, 6, O>;
#[doc = "Field `gain_ctrl12_g_rbb2` reader - "]
pub type GAIN_CTRL12_G_RBB2_R = crate::FieldReader<u8, u8>;
#[doc = "Field `gain_ctrl12_g_rbb2` writer - "]
pub type GAIN_CTRL12_G_RBB2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RBB_GAIN_CTRL12_SPEC, u8, u8, 3, O>;
#[doc = "Field `gain_ctrl12_g_rbb1` reader - "]
pub type GAIN_CTRL12_G_RBB1_R = crate::FieldReader<u8, u8>;
#[doc = "Field `gain_ctrl12_g_rbb1` writer - "]
pub type GAIN_CTRL12_G_RBB1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RBB_GAIN_CTRL12_SPEC, u8, u8, 2, O>;
impl R {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    ...
    pub fn gain_ctrl12_g_rbb2(&self) -> GAIN_CTRL12_G_RBB2_R {
        GAIN_CTRL12_G_RBB2_R::new(((self.bits >> 24) & 7) as u8)
    }
    #[doc = "Bits 28:29"]
    #[inline(always)]
    pub fn gain_ctrl12_g_rbb1(&self) -> GAIN_CTRL12_G_RBB1_R {
        GAIN_CTRL12_G_RBB1_R::new(((self.bits >> 28) & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:5"]
