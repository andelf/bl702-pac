...
pub type KCAL_RATIO_2414_R = crate::FieldReader<u16, u16>;
#[doc = "Field `kcal_ratio_2414` writer - "]
pub type KCAL_RATIO_2414_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LO_CONFIG_2414_SPEC, u16, u16, 10, O>;
#[doc = "Field `adpll_sdm_dither_en_2414` reader - "]
pub type ADPLL_SDM_DITHER_EN_2414_R = crate::BitReader<bool>;
#[doc = "Field `adpll_sdm_dither_en_2414` writer - "]
pub type ADPLL_SDM_DITHER_EN_2414_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LO_CONFIG_2414_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:9"]
    #[inline(always)]
    ...
    pub fn adpll_sdm_dither_en_2414(&self) -> ADPLL_SDM_DITHER_EN_2414_R {
        ADPLL_SDM_DITHER_EN_2414_R::new(((self.bits >> 12) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:9"]
    #[inline(always)]
    #[must_use]
    pub fn kcal_ratio_2414(&mut self) -> KCAL_RATIO_2414_W<0> {
        KCAL_RATIO_2414_W::new(self)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn adpll_sdm_dither_en_2414(&mut self) -> ADPLL_SDM_DITHER_EN_2414_W<12> {
        ADPLL_SDM_DITHER_EN_2414_W::new(self)
    }
