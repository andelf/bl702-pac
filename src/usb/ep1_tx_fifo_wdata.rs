...
pub type EP1_TX_FIFO_WDATA_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ep1_tx_fifo_wdata` writer - "]
pub type EP1_TX_FIFO_WDATA_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, EP1_TX_FIFO_WDATA_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ep1_tx_fifo_wdata(&mut self) -> EP1_TX_FIFO_WDATA_W<0> {
        EP1_TX_FIFO_WDATA_W::new(self)
    }
