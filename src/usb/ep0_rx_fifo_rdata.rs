...
pub struct EP0_RX_FIFO_RDATA_R(crate::FieldReader<u8, u8>);
impl EP0_RX_FIFO_RDATA_R {
    pub(crate) fn new(bits: u8) -> Self {
        EP0_RX_FIFO_RDATA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EP0_RX_FIFO_RDATA_R {
...
pub struct EP0_RX_FIFO_RDATA_W<'a> {
    w: &'a mut W,
}
impl<'a> EP0_RX_FIFO_RDATA_W<'a> {
...
impl W {
    #[doc = "Bits 0:7"]
    #[inline(always)]
    pub fn ep0_rx_fifo_rdata(&mut self) -> EP0_RX_FIFO_RDATA_W {
        EP0_RX_FIFO_RDATA_W { w: self }
    }
