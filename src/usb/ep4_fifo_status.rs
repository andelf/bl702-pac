...
pub type EP4_TX_FIFO_CNT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ep4_tx_fifo_cnt` writer - "]
pub type EP4_TX_FIFO_CNT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, EP4_FIFO_STATUS_SPEC, u8, u8, 7, O>;
#[doc = "Field `ep4_tx_fifo_empty` reader - "]
pub type EP4_TX_FIFO_EMPTY_R = crate::BitReader<bool>;
#[doc = "Field `ep4_tx_fifo_empty` writer - "]
pub type EP4_TX_FIFO_EMPTY_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EP4_FIFO_STATUS_SPEC, bool, O>;
#[doc = "Field `ep4_tx_fifo_full` reader - "]
pub type EP4_TX_FIFO_FULL_R = crate::BitReader<bool>;
#[doc = "Field `ep4_tx_fifo_full` writer - "]
pub type EP4_TX_FIFO_FULL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EP4_FIFO_STATUS_SPEC, bool, O>;
#[doc = "Field `ep4_rx_fifo_cnt` reader - "]
pub type EP4_RX_FIFO_CNT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ep4_rx_fifo_cnt` writer - "]
pub type EP4_RX_FIFO_CNT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, EP4_FIFO_STATUS_SPEC, u8, u8, 7, O>;
#[doc = "Field `ep4_rx_fifo_empty` reader - "]
pub type EP4_RX_FIFO_EMPTY_R = crate::BitReader<bool>;
#[doc = "Field `ep4_rx_fifo_empty` writer - "]
pub type EP4_RX_FIFO_EMPTY_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EP4_FIFO_STATUS_SPEC, bool, O>;
#[doc = "Field `ep4_rx_fifo_full` reader - "]
pub type EP4_RX_FIFO_FULL_R = crate::BitReader<bool>;
#[doc = "Field `ep4_rx_fifo_full` writer - "]
pub type EP4_RX_FIFO_FULL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EP4_FIFO_STATUS_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:6"]
    #[inline(always)]
    ...
    pub fn ep4_tx_fifo_empty(&self) -> EP4_TX_FIFO_EMPTY_R {
        EP4_TX_FIFO_EMPTY_R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    pub fn ep4_tx_fifo_full(&self) -> EP4_TX_FIFO_FULL_R {
        EP4_TX_FIFO_FULL_R::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bits 16:22"]
    #[inline(always)]
    ...
    pub fn ep4_rx_fifo_empty(&self) -> EP4_RX_FIFO_EMPTY_R {
        EP4_RX_FIFO_EMPTY_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    pub fn ep4_rx_fifo_full(&self) -> EP4_RX_FIFO_FULL_R {
        EP4_RX_FIFO_FULL_R::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:6"]
    #[inline(always)]
    pub fn ep4_tx_fifo_cnt(&mut self) -> EP4_TX_FIFO_CNT_W<0> {
        EP4_TX_FIFO_CNT_W::new(self)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    pub fn ep4_tx_fifo_empty(&mut self) -> EP4_TX_FIFO_EMPTY_W<14> {
        EP4_TX_FIFO_EMPTY_W::new(self)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    pub fn ep4_tx_fifo_full(&mut self) -> EP4_TX_FIFO_FULL_W<15> {
        EP4_TX_FIFO_FULL_W::new(self)
    }
    #[doc = "Bits 16:22"]
    #[inline(always)]
    pub fn ep4_rx_fifo_cnt(&mut self) -> EP4_RX_FIFO_CNT_W<16> {
        EP4_RX_FIFO_CNT_W::new(self)
    }
    #[doc = "Bit 30"]
    #[inline(always)]
    pub fn ep4_rx_fifo_empty(&mut self) -> EP4_RX_FIFO_EMPTY_W<30> {
        EP4_RX_FIFO_EMPTY_W::new(self)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    pub fn ep4_rx_fifo_full(&mut self) -> EP4_RX_FIFO_FULL_W<31> {
        EP4_RX_FIFO_FULL_W::new(self)
    }
