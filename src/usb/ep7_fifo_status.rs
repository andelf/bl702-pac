#[doc = "Register `ep7_fifo_status` reader"]
pub struct R(crate::R<EP7_FIFO_STATUS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EP7_FIFO_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EP7_FIFO_STATUS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EP7_FIFO_STATUS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ep7_fifo_status` writer"]
pub struct W(crate::W<EP7_FIFO_STATUS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EP7_FIFO_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EP7_FIFO_STATUS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EP7_FIFO_STATUS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct EP7_FIFO_STATUS_SPEC;
impl crate::RegisterSpec for EP7_FIFO_STATUS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ep7_fifo_status::R](R) reader structure"]
impl crate::Readable for EP7_FIFO_STATUS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ep7_fifo_status::W](W) writer structure"]
impl crate::Writable for EP7_FIFO_STATUS_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets ep7_fifo_status to value 0"]
impl crate::Resettable for EP7_FIFO_STATUS_SPEC {
    #[inline(always)]
