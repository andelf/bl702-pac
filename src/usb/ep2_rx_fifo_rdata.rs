...
pub struct EP2_RX_FIFO_RDATA_R(crate::FieldReader<u8, u8>);
impl EP2_RX_FIFO_RDATA_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        EP2_RX_FIFO_RDATA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EP2_RX_FIFO_RDATA_R {
...
pub struct EP2_RX_FIFO_RDATA_W<'a> {
    w: &'a mut W,
}
impl<'a> EP2_RX_FIFO_RDATA_W<'a> {
...
impl W {
    #[doc = "Bits 0:7"]
    #[inline(always)]
    pub fn ep2_rx_fifo_rdata(&mut self) -> EP2_RX_FIFO_RDATA_W {
        EP2_RX_FIFO_RDATA_W { w: self }
    }
