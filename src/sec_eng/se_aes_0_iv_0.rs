...
impl From<crate::R<SE_AES_0_IV_0_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<SE_AES_0_IV_0_SPEC>> for W {
    #[inline(always)]
...
pub type SE_AES_0_IV_0_R = crate::FieldReader<u32, u32>;
#[doc = "Field `se_aes_0_iv_0` writer - "]
pub type SE_AES_0_IV_0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SE_AES_0_IV_0_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn se_aes_0_iv_0(&self) -> SE_AES_0_IV_0_R {
        SE_AES_0_IV_0_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn se_aes_0_iv_0(&mut self) -> SE_AES_0_IV_0_W<0> {
        SE_AES_0_IV_0_W::new(self)
    }
