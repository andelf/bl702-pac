...
pub struct SE_SHA_0_STATUS_R(crate::FieldReader<u32, u32>);
impl SE_SHA_0_STATUS_R {
    pub(crate) fn new(bits: u32) -> Self {
        SE_SHA_0_STATUS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SE_SHA_0_STATUS_R {
...
pub struct SE_SHA_0_STATUS_W<'a> {
    w: &'a mut W,
}
impl<'a> SE_SHA_0_STATUS_W<'a> {
...
impl R {
    ...
    pub fn se_sha_0_status(&self) -> SE_SHA_0_STATUS_R {
        SE_SHA_0_STATUS_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn se_sha_0_status(&mut self) -> SE_SHA_0_STATUS_W {
        SE_SHA_0_STATUS_W { w: self }
    }
