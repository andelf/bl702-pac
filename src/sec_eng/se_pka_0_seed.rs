...
pub struct SE_PKA_0_SEED_R(crate::FieldReader<u32, u32>);
impl SE_PKA_0_SEED_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SE_PKA_0_SEED_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SE_PKA_0_SEED_R {
...
pub struct SE_PKA_0_SEED_W<'a> {
    w: &'a mut W,
}
impl<'a> SE_PKA_0_SEED_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn se_pka_0_seed(&mut self) -> SE_PKA_0_SEED_W {
        SE_PKA_0_SEED_W { w: self }
    }
