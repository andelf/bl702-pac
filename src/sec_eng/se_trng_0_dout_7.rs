...
pub struct SE_TRNG_0_DOUT_7_R(crate::FieldReader<u32, u32>);
impl SE_TRNG_0_DOUT_7_R {
    pub(crate) fn new(bits: u32) -> Self {
        SE_TRNG_0_DOUT_7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SE_TRNG_0_DOUT_7_R {
...
pub struct SE_TRNG_0_DOUT_7_W<'a> {
    w: &'a mut W,
}
impl<'a> SE_TRNG_0_DOUT_7_W<'a> {
...
impl R {
    ...
    pub fn se_trng_0_dout_7(&self) -> SE_TRNG_0_DOUT_7_R {
        SE_TRNG_0_DOUT_7_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn se_trng_0_dout_7(&mut self) -> SE_TRNG_0_DOUT_7_W {
        SE_TRNG_0_DOUT_7_W { w: self }
    }
