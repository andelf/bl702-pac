...
pub type SE_CDET_0_ERROR_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SE_CDET_0_CTRL_0_SPEC, bool, O>;
#[doc = "Field `se_cdet_0_status` reader - "]
pub type SE_CDET_0_STATUS_R = crate::FieldReader<u16, u16>;
#[doc = "Field `se_cdet_0_status` writer - "]
pub type SE_CDET_0_STATUS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SE_CDET_0_CTRL_0_SPEC, u16, u16, 14, O>;
...
impl W {
    ...
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn se_cdet_0_error(&mut self) -> SE_CDET_0_ERROR_W<1> {
        SE_CDET_0_ERROR_W::new(self)
    }
    #[doc = "Bits 2:15"]
    #[inline(always)]
    pub fn se_cdet_0_status(&mut self) -> SE_CDET_0_STATUS_W<2> {
        SE_CDET_0_STATUS_W::new(self)
    }
    #[doc = "Bits 16:23"]
    #[inline(always)]
