...
pub type SE_TRNG_0_TEST_OUT_2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SE_TRNG_0_TEST_OUT_2_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn se_trng_0_test_out_2(&mut self) -> SE_TRNG_0_TEST_OUT_2_W<0> {
        SE_TRNG_0_TEST_OUT_2_W::new(self)
    }
