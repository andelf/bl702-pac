...
pub struct SE_AES_0_KEY_2_R(crate::FieldReader<u32, u32>);
impl SE_AES_0_KEY_2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SE_AES_0_KEY_2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SE_AES_0_KEY_2_R {
...
pub struct SE_AES_0_KEY_2_W<'a> {
    w: &'a mut W,
}
impl<'a> SE_AES_0_KEY_2_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn se_aes_0_key_2(&mut self) -> SE_AES_0_KEY_2_W {
        SE_AES_0_KEY_2_W { w: self }
    }
