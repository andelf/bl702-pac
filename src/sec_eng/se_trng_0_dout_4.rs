...
pub struct W(crate::W<SE_TRNG_0_DOUT_4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SE_TRNG_0_DOUT_4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SE_TRNG_0_DOUT_4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SE_TRNG_0_DOUT_4_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SE_TRNG_0_DOUT_4_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SE_TRNG_0_DOUT_4_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn se_trng_0_dout_4(&mut self) -> SE_TRNG_0_DOUT_4_W<0> {
        SE_TRNG_0_DOUT_4_W::new(self)
    }
...
impl crate::Writable for SE_TRNG_0_DOUT_4_SPEC {
    type Writer = W;
}
