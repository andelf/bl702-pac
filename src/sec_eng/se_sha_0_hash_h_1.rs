...
pub struct W(crate::W<SE_SHA_0_HASH_H_1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SE_SHA_0_HASH_H_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SE_SHA_0_HASH_H_1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SE_SHA_0_HASH_H_1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SE_SHA_0_HASH_H_1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SE_SHA_0_HASH_H_1_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn se_sha_0_hash_h_1(&mut self) -> SE_SHA_0_HASH_H_1_W<0> {
        SE_SHA_0_HASH_H_1_W::new(self)
    }
...
impl crate::Writable for SE_SHA_0_HASH_H_1_SPEC {
    type Writer = W;
}
