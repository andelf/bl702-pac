...
impl From<crate::R<SE_SHA_0_CTRL_PROT_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<SE_SHA_0_CTRL_PROT_SPEC>> for W {
    #[inline(always)]
...
pub type SE_SHA_PROT_EN_R = crate::BitReader<bool>;
#[doc = "Field `se_sha_prot_en` writer - "]
pub type SE_SHA_PROT_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SE_SHA_0_CTRL_PROT_SPEC, bool, O>;
#[doc = "Field `se_sha_id0_en` reader - "]
pub type SE_SHA_ID0_EN_R = crate::BitReader<bool>;
#[doc = "Field `se_sha_id0_en` writer - "]
pub type SE_SHA_ID0_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SE_SHA_0_CTRL_PROT_SPEC, bool, O>;
#[doc = "Field `se_sha_id1_en` reader - "]
pub type SE_SHA_ID1_EN_R = crate::BitReader<bool>;
#[doc = "Field `se_sha_id1_en` writer - "]
pub type SE_SHA_ID1_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SE_SHA_0_CTRL_PROT_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn se_sha_prot_en(&self) -> SE_SHA_PROT_EN_R {
        SE_SHA_PROT_EN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn se_sha_id0_en(&self) -> SE_SHA_ID0_EN_R {
        SE_SHA_ID0_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn se_sha_id1_en(&self) -> SE_SHA_ID1_EN_R {
        SE_SHA_ID1_EN_R::new(((self.bits >> 2) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn se_sha_prot_en(&mut self) -> SE_SHA_PROT_EN_W<0> {
        SE_SHA_PROT_EN_W::new(self)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn se_sha_id0_en(&mut self) -> SE_SHA_ID0_EN_W<1> {
        SE_SHA_ID0_EN_W::new(self)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn se_sha_id1_en(&mut self) -> SE_SHA_ID1_EN_W<2> {
        SE_SHA_ID1_EN_W::new(self)
    }
