...
impl R {
    ...
    pub fn se_sha_id1_en(&self) -> SE_SHA_ID1_EN_R {
        SE_SHA_ID1_EN_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn se_sha_id0_en(&self) -> SE_SHA_ID0_EN_R {
        SE_SHA_ID0_EN_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn se_sha_prot_en(&self) -> SE_SHA_PROT_EN_R {
        SE_SHA_PROT_EN_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn se_sha_id1_en(&mut self) -> SE_SHA_ID1_EN_W {
        SE_SHA_ID1_EN_W { w: self }
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn se_sha_id0_en(&mut self) -> SE_SHA_ID0_EN_W {
        SE_SHA_ID0_EN_W { w: self }
    }
    #[doc = "Bit 0"]
    #[inline(always)]
