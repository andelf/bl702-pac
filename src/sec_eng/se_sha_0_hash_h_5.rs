...
pub type SE_SHA_0_HASH_H_5_R = crate::FieldReader<u32, u32>;
#[doc = "Field `se_sha_0_hash_h_5` writer - "]
pub type SE_SHA_0_HASH_H_5_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SE_SHA_0_HASH_H_5_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn se_sha_0_hash_h_5(&mut self) -> SE_SHA_0_HASH_H_5_W<0> {
        SE_SHA_0_HASH_H_5_W::new(self)
    }
