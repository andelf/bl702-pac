...
impl From<crate::R<SE_AES_0_KEY_4_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<SE_AES_0_KEY_4_SPEC>> for W {
    #[inline(always)]
...
pub type SE_AES_0_KEY_4_R = crate::FieldReader<u32, u32>;
#[doc = "Field `se_aes_0_key_4` writer - "]
pub type SE_AES_0_KEY_4_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SE_AES_0_KEY_4_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn se_aes_0_key_4(&self) -> SE_AES_0_KEY_4_R {
        SE_AES_0_KEY_4_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn se_aes_0_key_4(&mut self) -> SE_AES_0_KEY_4_W<0> {
        SE_AES_0_KEY_4_W::new(self)
    }
