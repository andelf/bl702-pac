...
pub struct W(crate::W<SE_AES_0_STATUS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SE_AES_0_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SE_AES_0_STATUS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SE_AES_0_STATUS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SE_AES_0_STATUS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SE_AES_0_STATUS_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn se_aes_0_status(&mut self) -> SE_AES_0_STATUS_W<0> {
        SE_AES_0_STATUS_W::new(self)
    }
...
impl crate::Writable for SE_AES_0_STATUS_SPEC {
    type Writer = W;
