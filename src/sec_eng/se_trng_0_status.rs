...
pub type SE_TRNG_0_STATUS_R = crate::FieldReader<u32, u32>;
#[doc = "Field `se_trng_0_status` writer - "]
pub type SE_TRNG_0_STATUS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SE_TRNG_0_STATUS_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn se_trng_0_status(&mut self) -> SE_TRNG_0_STATUS_W<0> {
        SE_TRNG_0_STATUS_W::new(self)
    }
