...
pub struct SE_TRNG_0_TEST_OUT_3_W<'a> {
    w: &'a mut W,
}
impl<'a> SE_TRNG_0_TEST_OUT_3_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn se_trng_0_test_out_3(&mut self) -> SE_TRNG_0_TEST_OUT_3_W {
        SE_TRNG_0_TEST_OUT_3_W { w: self }
    }
