...
#[doc = "Register `se_trng_0_test_out_3` writer"]
pub struct W(crate::W<SE_TRNG_0_TEST_OUT_3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SE_TRNG_0_TEST_OUT_3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SE_TRNG_0_TEST_OUT_3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SE_TRNG_0_TEST_OUT_3_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `se_trng_0_test_out_3` reader - "]
pub type SE_TRNG_0_TEST_OUT_3_R = crate::FieldReader<u32, u32>;
#[doc = "Field `se_trng_0_test_out_3` writer - "]
pub type SE_TRNG_0_TEST_OUT_3_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SE_TRNG_0_TEST_OUT_3_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn se_trng_0_test_out_3(&mut self) -> SE_TRNG_0_TEST_OUT_3_W<0> {
        SE_TRNG_0_TEST_OUT_3_W::new(self)
    }
...
#[doc = "`write(|w| ..)` method takes [se_trng_0_test_out_3::W](W) writer structure"]
impl crate::Writable for SE_TRNG_0_TEST_OUT_3_SPEC {
    type Writer = W;
