...
pub type SE_PKA_0_DONE_W<'a, const O: u8> =
...
pub type SE_PKA_0_BUSY_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SE_PKA_0_CTRL_0_SPEC, bool, O>;
...
pub type SE_PKA_0_INT_W<'a, const O: u8> = crate::BitWriter<'a, u32, SE_PKA_0_CTRL_0_SPEC, bool, O>;
...
pub type SE_PKA_0_STATUS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SE_PKA_0_CTRL_0_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
    ...
    pub fn se_pka_0_status_clr_1t(&self) -> SE_PKA_0_STATUS_CLR_1T_R {
        SE_PKA_0_STATUS_CLR_1T_R::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bits 16:31"]
    #[inline(always)]
    pub fn se_pka_0_status(&self) -> SE_PKA_0_STATUS_R {
        SE_PKA_0_STATUS_R::new(((self.bits >> 16) & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn se_pka_0_done(&mut self) -> SE_PKA_0_DONE_W<0> {
        SE_PKA_0_DONE_W::new(self)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    ...
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn se_pka_0_busy(&mut self) -> SE_PKA_0_BUSY_W<2> {
        SE_PKA_0_BUSY_W::new(self)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    ...
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn se_pka_0_int(&mut self) -> SE_PKA_0_INT_W<8> {
        SE_PKA_0_INT_W::new(self)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    ...
    #[doc = "Bit 15"]
    #[inline(always)]
    pub fn se_pka_0_status_clr_1t(&mut self) -> SE_PKA_0_STATUS_CLR_1T_W<15> {
        SE_PKA_0_STATUS_CLR_1T_W::new(self)
    }
    #[doc = "Bits 16:31"]
    #[inline(always)]
    pub fn se_pka_0_status(&mut self) -> SE_PKA_0_STATUS_W<16> {
        SE_PKA_0_STATUS_W::new(self)
    }
