...
pub struct SE_SHA_0_INT_W<'a> {
    w: &'a mut W,
}
impl<'a> SE_SHA_0_INT_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub struct SE_SHA_0_BUSY_W<'a> {
    w: &'a mut W,
}
impl<'a> SE_SHA_0_BUSY_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl W {
    ...
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn se_sha_0_int(&mut self) -> SE_SHA_0_INT_W {
        SE_SHA_0_INT_W { w: self }
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    ...
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn se_sha_0_busy(&mut self) -> SE_SHA_0_BUSY_W {
        SE_SHA_0_BUSY_W { w: self }
    }
