...
pub type SE_AES_0_BUSY_W<'a, const O: u8> = crate::BitWriter<'a, u32, SE_AES_0_CTRL_SPEC, bool, O>;
...
pub type SE_AES_0_INT_W<'a, const O: u8> = crate::BitWriter<'a, u32, SE_AES_0_CTRL_SPEC, bool, O>;
...
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn se_aes_0_busy(&mut self) -> SE_AES_0_BUSY_W<0> {
        SE_AES_0_BUSY_W::new(self)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    ...
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn se_aes_0_int(&mut self) -> SE_AES_0_INT_W<8> {
        SE_AES_0_INT_W::new(self)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
