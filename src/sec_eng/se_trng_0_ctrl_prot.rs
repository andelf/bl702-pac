...
pub struct R(crate::R<SE_TRNG_0_CTRL_PROT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SE_TRNG_0_CTRL_PROT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SE_TRNG_0_CTRL_PROT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SE_TRNG_0_CTRL_PROT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `se_trng_0_ctrl_prot` writer"]
pub struct W(crate::W<SE_TRNG_0_CTRL_PROT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SE_TRNG_0_CTRL_PROT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SE_TRNG_0_CTRL_PROT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SE_TRNG_0_CTRL_PROT_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "se_trng_0_ctrl_prot.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [se_trng_0_ctrl_prot](index.html) module"]
pub struct SE_TRNG_0_CTRL_PROT_SPEC;
impl crate::RegisterSpec for SE_TRNG_0_CTRL_PROT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [se_trng_0_ctrl_prot::R](R) reader structure"]
impl crate::Readable for SE_TRNG_0_CTRL_PROT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [se_trng_0_ctrl_prot::W](W) writer structure"]
impl crate::Writable for SE_TRNG_0_CTRL_PROT_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets se_trng_0_ctrl_prot to value 0"]
impl crate::Resettable for SE_TRNG_0_CTRL_PROT_SPEC {
    #[inline(always)]
