...
pub struct SE_CDET_ID1_EN_R(crate::FieldReader<bool, bool>);
impl SE_CDET_ID1_EN_R {
    pub(crate) fn new(bits: bool) -> Self {
        SE_CDET_ID1_EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SE_CDET_ID1_EN_R {
...
pub struct SE_CDET_ID1_EN_W<'a> {
    w: &'a mut W,
}
impl<'a> SE_CDET_ID1_EN_W<'a> {
...
pub struct SE_CDET_ID0_EN_R(crate::FieldReader<bool, bool>);
impl SE_CDET_ID0_EN_R {
    pub(crate) fn new(bits: bool) -> Self {
        SE_CDET_ID0_EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SE_CDET_ID0_EN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct SE_CDET_ID0_EN_W<'a> {
    w: &'a mut W,
}
impl<'a> SE_CDET_ID0_EN_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub struct SE_CDET_PROT_EN_R(crate::FieldReader<bool, bool>);
impl SE_CDET_PROT_EN_R {
    pub(crate) fn new(bits: bool) -> Self {
        SE_CDET_PROT_EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SE_CDET_PROT_EN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct SE_CDET_PROT_EN_W<'a> {
    w: &'a mut W,
}
impl<'a> SE_CDET_PROT_EN_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn se_cdet_id1_en(&self) -> SE_CDET_ID1_EN_R {
        SE_CDET_ID1_EN_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn se_cdet_id0_en(&self) -> SE_CDET_ID0_EN_R {
        SE_CDET_ID0_EN_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn se_cdet_prot_en(&self) -> SE_CDET_PROT_EN_R {
        SE_CDET_PROT_EN_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn se_cdet_id1_en(&mut self) -> SE_CDET_ID1_EN_W {
        SE_CDET_ID1_EN_W { w: self }
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn se_cdet_id0_en(&mut self) -> SE_CDET_ID0_EN_W {
        SE_CDET_ID0_EN_W { w: self }
    }
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn se_cdet_prot_en(&mut self) -> SE_CDET_PROT_EN_W {
        SE_CDET_PROT_EN_W { w: self }
    }
