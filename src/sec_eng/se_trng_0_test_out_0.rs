...
pub struct W(crate::W<SE_TRNG_0_TEST_OUT_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SE_TRNG_0_TEST_OUT_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SE_TRNG_0_TEST_OUT_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SE_TRNG_0_TEST_OUT_0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SE_TRNG_0_TEST_OUT_0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SE_TRNG_0_TEST_OUT_0_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn se_trng_0_test_out_0(&mut self) -> SE_TRNG_0_TEST_OUT_0_W<0> {
        SE_TRNG_0_TEST_OUT_0_W::new(self)
    }
...
impl crate::Writable for SE_TRNG_0_TEST_OUT_0_SPEC {
    type Writer = W;
