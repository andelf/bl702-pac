...
pub struct SE_SHA_0_HASH_L_2_R(crate::FieldReader<u32, u32>);
impl SE_SHA_0_HASH_L_2_R {
    pub(crate) fn new(bits: u32) -> Self {
        SE_SHA_0_HASH_L_2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SE_SHA_0_HASH_L_2_R {
