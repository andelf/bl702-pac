...
pub struct SE_CTRL_RESERVED_2_R(crate::FieldReader<u32, u32>);
impl SE_CTRL_RESERVED_2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SE_CTRL_RESERVED_2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SE_CTRL_RESERVED_2_R {
