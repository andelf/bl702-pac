...
pub type SE_TRNG_0_DOUT_5_R = crate::FieldReader<u32, u32>;
#[doc = "Field `se_trng_0_dout_5` writer - "]
pub type SE_TRNG_0_DOUT_5_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SE_TRNG_0_DOUT_5_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn se_trng_0_dout_5(&mut self) -> SE_TRNG_0_DOUT_5_W<0> {
        SE_TRNG_0_DOUT_5_W::new(self)
    }
