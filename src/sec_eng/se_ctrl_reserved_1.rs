...
pub struct SE_CTRL_RESERVED_1_R(crate::FieldReader<u32, u32>);
impl SE_CTRL_RESERVED_1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SE_CTRL_RESERVED_1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SE_CTRL_RESERVED_1_R {
...
pub struct SE_CTRL_RESERVED_1_W<'a> {
    w: &'a mut W,
}
impl<'a> SE_CTRL_RESERVED_1_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn se_ctrl_reserved_1(&mut self) -> SE_CTRL_RESERVED_1_W {
        SE_CTRL_RESERVED_1_W { w: self }
    }
