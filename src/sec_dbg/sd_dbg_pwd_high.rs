...
impl core::ops::Deref for SD_DBG_PWD_HIGH_R {
...
pub struct SD_DBG_PWD_HIGH_W<'a> {
    w: &'a mut W,
}
impl<'a> SD_DBG_PWD_HIGH_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn sd_dbg_pwd_high(&mut self) -> SD_DBG_PWD_HIGH_W {
        SD_DBG_PWD_HIGH_W { w: self }
    }
