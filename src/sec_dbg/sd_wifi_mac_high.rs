...
pub type SD_WIFI_MAC_HIGH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SD_WIFI_MAC_HIGH_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sd_wifi_mac_high(&mut self) -> SD_WIFI_MAC_HIGH_W<0> {
        SD_WIFI_MAC_HIGH_W::new(self)
    }
