...
pub struct W(crate::W<SD_WIFI_MAC_LOW_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SD_WIFI_MAC_LOW_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SD_WIFI_MAC_LOW_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SD_WIFI_MAC_LOW_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SD_WIFI_MAC_LOW_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SD_WIFI_MAC_LOW_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sd_wifi_mac_low(&mut self) -> SD_WIFI_MAC_LOW_W<0> {
        SD_WIFI_MAC_LOW_W::new(self)
    }
...
impl crate::Writable for SD_WIFI_MAC_LOW_SPEC {
    type Writer = W;
