...
pub type SD_DBG_PWD_BUSY_W<'a, const O: u8> = crate::BitWriter<'a, u32, SD_STATUS_SPEC, bool, O>;
...
pub type SD_DBG_PWD_CNT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SD_STATUS_SPEC, u32, u32, 20, O>;
#[doc = "Field `sd_dbg_mode` reader - "]
pub type SD_DBG_MODE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `sd_dbg_mode` writer - "]
pub type SD_DBG_MODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SD_STATUS_SPEC, u8, u8, 4, O>;
#[doc = "Field `sd_dbg_ena` reader - "]
pub type SD_DBG_ENA_R = crate::FieldReader<u8, u8>;
#[doc = "Field `sd_dbg_ena` writer - "]
pub type SD_DBG_ENA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SD_STATUS_SPEC, u8, u8, 4, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
