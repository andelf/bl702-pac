...
#[doc = "spi_int_sts."]
pub mod spi_int_sts;
#[doc = "spi_bus_busy (rw) register accessor: an alias for `Reg<SPI_BUS_BUSY_SPEC>`"]
...
#[doc = "spi_fifo_wdata (rw) register accessor: an alias for `Reg<SPI_FIFO_WDATA_SPEC>`"]
pub type SPI_FIFO_WDATA = crate::Reg<spi_fifo_wdata::SPI_FIFO_WDATA_SPEC>;
#[doc = "spi_fifo_wdata."]
pub mod spi_fifo_wdata;
#[doc = "spi_fifo_rdata (rw) register accessor: an alias for `Reg<SPI_FIFO_RDATA_SPEC>`"]
