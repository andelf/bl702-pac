...
pub type SPI_FIFO_RDATA_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SPI_FIFO_RDATA_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_fifo_rdata(&mut self) -> SPI_FIFO_RDATA_W<0> {
        SPI_FIFO_RDATA_W::new(self)
    }
