...
pub type APB_CCI_RDATA_R = crate::FieldReader<u32, u32>;
#[doc = "Field `apb_cci_rdata` writer - "]
pub type APB_CCI_RDATA_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CCI_RDATA_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn apb_cci_rdata(&mut self) -> APB_CCI_RDATA_W<0> {
        APB_CCI_RDATA_W::new(self)
    }
