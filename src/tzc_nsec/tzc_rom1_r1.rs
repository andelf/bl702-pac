...
pub type TZC_ROM1_R1_END_R = crate::FieldReader<u16, u16>;
#[doc = "Field `tzc_rom1_r1_end` writer - "]
pub type TZC_ROM1_R1_END_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_ROM1_R1_SPEC, u16, u16, 16, O>;
#[doc = "Field `tzc_rom1_r1_start` reader - "]
pub type TZC_ROM1_R1_START_R = crate::FieldReader<u16, u16>;
#[doc = "Field `tzc_rom1_r1_start` writer - "]
pub type TZC_ROM1_R1_START_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_ROM1_R1_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
