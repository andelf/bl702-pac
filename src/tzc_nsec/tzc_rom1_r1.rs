...
impl From<crate::R<TZC_ROM1_R1_SPEC>> for R {
    #[inline(always)]
...
pub struct W(crate::W<TZC_ROM1_R1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TZC_ROM1_R1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TZC_ROM1_R1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TZC_ROM1_R1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct TZC_ROM1_R1_START_W<'a> {
    w: &'a mut W,
}
impl<'a> TZC_ROM1_R1_START_W<'a> {
...
pub struct TZC_ROM1_R1_END_W<'a> {
    w: &'a mut W,
}
impl<'a> TZC_ROM1_R1_END_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u16) -> &'a mut W {
...
impl W {
    #[doc = "Bits 16:31"]
    #[inline(always)]
    pub fn tzc_rom1_r1_start(&mut self) -> TZC_ROM1_R1_START_W {
        TZC_ROM1_R1_START_W { w: self }
    }
    #[doc = "Bits 0:15"]
    #[inline(always)]
    pub fn tzc_rom1_r1_end(&mut self) -> TZC_ROM1_R1_END_W {
        TZC_ROM1_R1_END_W { w: self }
    }
