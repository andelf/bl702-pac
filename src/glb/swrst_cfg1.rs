...
pub type SWRST_S1A8_R = crate::BitReader<bool>;
#[doc = "Field `swrst_s1a8` writer - "]
pub type SWRST_S1A8_W<'a, const O: u8> = crate::BitWriter<'a, u32, SWRST_CFG1_SPEC, bool, O>;
#[doc = "Field `swrst_s1a9` reader - "]
pub type SWRST_S1A9_R = crate::BitReader<bool>;
#[doc = "Field `swrst_s1a9` writer - "]
pub type SWRST_S1A9_W<'a, const O: u8> = crate::BitWriter<'a, u32, SWRST_CFG1_SPEC, bool, O>;
#[doc = "Field `swrst_s1aa` reader - "]
pub type SWRST_S1AA_R = crate::BitReader<bool>;
#[doc = "Field `swrst_s1aa` writer - "]
pub type SWRST_S1AA_W<'a, const O: u8> = crate::BitWriter<'a, u32, SWRST_CFG1_SPEC, bool, O>;
#[doc = "Field `swrst_s1ab` reader - "]
pub type SWRST_S1AB_R = crate::BitReader<bool>;
#[doc = "Field `swrst_s1ab` writer - "]
pub type SWRST_S1AB_W<'a, const O: u8> = crate::BitWriter<'a, u32, SWRST_CFG1_SPEC, bool, O>;
#[doc = "Field `swrst_s1ac` reader - "]
pub type SWRST_S1AC_R = crate::BitReader<bool>;
#[doc = "Field `swrst_s1ac` writer - "]
pub type SWRST_S1AC_W<'a, const O: u8> = crate::BitWriter<'a, u32, SWRST_CFG1_SPEC, bool, O>;
#[doc = "Field `swrst_s1ad` reader - "]
pub type SWRST_S1AD_R = crate::BitReader<bool>;
#[doc = "Field `swrst_s1ad` writer - "]
pub type SWRST_S1AD_W<'a, const O: u8> = crate::BitWriter<'a, u32, SWRST_CFG1_SPEC, bool, O>;
#[doc = "Field `swrst_s1ae` reader - "]
pub type SWRST_S1AE_R = crate::BitReader<bool>;
#[doc = "Field `swrst_s1ae` writer - "]
pub type SWRST_S1AE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SWRST_CFG1_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
    ...
    pub fn swrst_s1a8(&self) -> SWRST_S1A8_R {
        SWRST_S1A8_R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    pub fn swrst_s1a9(&self) -> SWRST_S1A9_R {
        SWRST_S1A9_R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    pub fn swrst_s1aa(&self) -> SWRST_S1AA_R {
        SWRST_S1AA_R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    pub fn swrst_s1ab(&self) -> SWRST_S1AB_R {
        SWRST_S1AB_R::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bit 28"]
    #[inline(always)]
    pub fn swrst_s1ac(&self) -> SWRST_S1AC_R {
        SWRST_S1AC_R::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29"]
    #[inline(always)]
    pub fn swrst_s1ad(&self) -> SWRST_S1AD_R {
        SWRST_S1AD_R::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30"]
    #[inline(always)]
    pub fn swrst_s1ae(&self) -> SWRST_S1AE_R {
        SWRST_S1AE_R::new(((self.bits >> 30) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0"]
