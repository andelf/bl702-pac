...
pub type REG_GPIO_INT_MASK1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `reg_gpio_int_mask1` writer - "]
pub type REG_GPIO_INT_MASK1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPIO_INT_MASK1_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn reg_gpio_int_mask1(&mut self) -> REG_GPIO_INT_MASK1_W<0> {
        REG_GPIO_INT_MASK1_W::new(self)
    }
