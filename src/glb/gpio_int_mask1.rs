...
pub struct REG_GPIO_INT_MASK1_R(crate::FieldReader<u32, u32>);
impl REG_GPIO_INT_MASK1_R {
    pub(crate) fn new(bits: u32) -> Self {
        REG_GPIO_INT_MASK1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for REG_GPIO_INT_MASK1_R {
...
pub struct REG_GPIO_INT_MASK1_W<'a> {
    w: &'a mut W,
}
impl<'a> REG_GPIO_INT_MASK1_W<'a> {
...
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn reg_gpio_int_mask1(&self) -> REG_GPIO_INT_MASK1_R {
        REG_GPIO_INT_MASK1_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn reg_gpio_int_mask1(&mut self) -> REG_GPIO_INT_MASK1_W {
        REG_GPIO_INT_MASK1_W { w: self }
    }
