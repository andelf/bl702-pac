...
pub struct REG_GPIO_27_FUNC_SEL_R(crate::FieldReader<u8, u8>);
impl REG_GPIO_27_FUNC_SEL_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        REG_GPIO_27_FUNC_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for REG_GPIO_27_FUNC_SEL_R {
...
pub struct REG_GPIO_27_FUNC_SEL_W<'a> {
    w: &'a mut W,
}
impl<'a> REG_GPIO_27_FUNC_SEL_W<'a> {
...
pub struct REG_GPIO_26_FUNC_SEL_R(crate::FieldReader<u8, u8>);
impl REG_GPIO_26_FUNC_SEL_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        REG_GPIO_26_FUNC_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for REG_GPIO_26_FUNC_SEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct REG_GPIO_26_FUNC_SEL_W<'a> {
    w: &'a mut W,
}
impl<'a> REG_GPIO_26_FUNC_SEL_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl W {
    #[doc = "Bits 24:28"]
    #[inline(always)]
    pub fn reg_gpio_27_func_sel(&mut self) -> REG_GPIO_27_FUNC_SEL_W {
        REG_GPIO_27_FUNC_SEL_W { w: self }
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    ...
    #[doc = "Bits 8:12"]
    #[inline(always)]
    pub fn reg_gpio_26_func_sel(&mut self) -> REG_GPIO_26_FUNC_SEL_W {
        REG_GPIO_26_FUNC_SEL_W { w: self }
    }
    #[doc = "Bit 5"]
    #[inline(always)]
