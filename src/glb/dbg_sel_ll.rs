...
pub struct REG_DBG_LL_CTRL_R(crate::FieldReader<u32, u32>);
impl REG_DBG_LL_CTRL_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        REG_DBG_LL_CTRL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for REG_DBG_LL_CTRL_R {
...
pub struct REG_DBG_LL_CTRL_W<'a> {
    w: &'a mut W,
}
impl<'a> REG_DBG_LL_CTRL_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn reg_dbg_ll_ctrl(&mut self) -> REG_DBG_LL_CTRL_W {
        REG_DBG_LL_CTRL_W { w: self }
    }
