...
impl From<crate::R<GPIO_CFGCTL35_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIO_CFGCTL35_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPIO_CFGCTL35` writer"]
pub struct W(crate::W<GPIO_CFGCTL35_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIO_CFGCTL35_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPIO_CFGCTL35_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPIO_CFGCTL35_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [gpio_cfgctl35::W](W) writer structure"]
impl crate::Writable for GPIO_CFGCTL35_SPEC {
    type Writer = W;
}
