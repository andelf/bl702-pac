...
pub type REG_GPIO_INT_MODE_SET3_R = crate::FieldReader<u32, u32>;
#[doc = "Field `reg_gpio_int_mode_set3` writer - "]
pub type REG_GPIO_INT_MODE_SET3_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPIO_INT_MODE_SET3_SPEC, u32, u32, 30, O>;
impl R {
    #[doc = "Bits 0:29"]
    #[inline(always)]
    pub fn reg_gpio_int_mode_set3(&self) -> REG_GPIO_INT_MODE_SET3_R {
        REG_GPIO_INT_MODE_SET3_R::new((self.bits & 0x3fff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:29"]
    #[inline(always)]
    pub fn reg_gpio_int_mode_set3(&mut self) -> REG_GPIO_INT_MODE_SET3_W<0> {
        REG_GPIO_INT_MODE_SET3_W::new(self)
    }
