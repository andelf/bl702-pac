...
pub struct REG_GPIO_INT_MODE_SET3_R(crate::FieldReader<u32, u32>);
impl REG_GPIO_INT_MODE_SET3_R {
    pub(crate) fn new(bits: u32) -> Self {
        REG_GPIO_INT_MODE_SET3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for REG_GPIO_INT_MODE_SET3_R {
