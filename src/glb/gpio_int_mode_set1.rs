...
pub type REG_GPIO_INT_MODE_SET1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `reg_gpio_int_mode_set1` writer - "]
pub type REG_GPIO_INT_MODE_SET1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPIO_INT_MODE_SET1_SPEC, u32, u32, 30, O>;
impl R {
    #[doc = "Bits 0:29"]
    #[inline(always)]
