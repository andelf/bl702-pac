...
pub struct REG_GPIO_INT_MODE_SET1_R(crate::FieldReader<u32, u32>);
impl REG_GPIO_INT_MODE_SET1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        REG_GPIO_INT_MODE_SET1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for REG_GPIO_INT_MODE_SET1_R {
...
pub struct REG_GPIO_INT_MODE_SET1_W<'a> {
    w: &'a mut W,
}
impl<'a> REG_GPIO_INT_MODE_SET1_W<'a> {
...
impl W {
    #[doc = "Bits 0:29"]
    #[inline(always)]
    pub fn reg_gpio_int_mode_set1(&mut self) -> REG_GPIO_INT_MODE_SET1_W {
        REG_GPIO_INT_MODE_SET1_W { w: self }
    }
