...
pub struct GPIO_INT_STAT1_R(crate::FieldReader<u32, u32>);
impl GPIO_INT_STAT1_R {
    pub(crate) fn new(bits: u32) -> Self {
        GPIO_INT_STAT1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GPIO_INT_STAT1_R {
