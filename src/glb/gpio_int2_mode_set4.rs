...
impl core::ops::Deref for REG_GPIO_INT2_MODE_SET4_R {
...
pub struct REG_GPIO_INT2_MODE_SET4_W<'a> {
    w: &'a mut W,
}
impl<'a> REG_GPIO_INT2_MODE_SET4_W<'a> {
...
impl W {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn reg_gpio_int2_mode_set4(&mut self) -> REG_GPIO_INT2_MODE_SET4_W {
        REG_GPIO_INT2_MODE_SET4_W { w: self }
    }
