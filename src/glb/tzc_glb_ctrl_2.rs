...
impl core::ops::Deref for TZC_GLB_GPIO_31_LOCK_R {
...
pub struct TZC_GLB_GPIO_31_LOCK_W<'a> {
    w: &'a mut W,
}
impl<'a> TZC_GLB_GPIO_31_LOCK_W<'a> {
...
impl core::ops::Deref for TZC_GLB_GPIO_30_LOCK_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct TZC_GLB_GPIO_30_LOCK_W<'a> {
    w: &'a mut W,
}
impl<'a> TZC_GLB_GPIO_30_LOCK_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl core::ops::Deref for TZC_GLB_GPIO_29_LOCK_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct TZC_GLB_GPIO_29_LOCK_W<'a> {
    w: &'a mut W,
}
impl<'a> TZC_GLB_GPIO_29_LOCK_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn tzc_glb_gpio_31_lock(&self) -> TZC_GLB_GPIO_31_LOCK_R {
        TZC_GLB_GPIO_31_LOCK_R::new(((self.bits >> 31) & 0x01) != 0)
    }
    #[doc = "Bit 30"]
    #[inline(always)]
    pub fn tzc_glb_gpio_30_lock(&self) -> TZC_GLB_GPIO_30_LOCK_R {
        TZC_GLB_GPIO_30_LOCK_R::new(((self.bits >> 30) & 0x01) != 0)
    }
    #[doc = "Bit 29"]
    #[inline(always)]
    pub fn tzc_glb_gpio_29_lock(&self) -> TZC_GLB_GPIO_29_LOCK_R {
        TZC_GLB_GPIO_29_LOCK_R::new(((self.bits >> 29) & 0x01) != 0)
    }
    #[doc = "Bit 28"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 31"]
    #[inline(always)]
    pub fn tzc_glb_gpio_31_lock(&mut self) -> TZC_GLB_GPIO_31_LOCK_W {
        TZC_GLB_GPIO_31_LOCK_W { w: self }
    }
    #[doc = "Bit 30"]
    #[inline(always)]
    pub fn tzc_glb_gpio_30_lock(&mut self) -> TZC_GLB_GPIO_30_LOCK_W {
        TZC_GLB_GPIO_30_LOCK_W { w: self }
    }
    #[doc = "Bit 29"]
    #[inline(always)]
    pub fn tzc_glb_gpio_29_lock(&mut self) -> TZC_GLB_GPIO_29_LOCK_W {
        TZC_GLB_GPIO_29_LOCK_W { w: self }
    }
    #[doc = "Bit 28"]
    #[inline(always)]
