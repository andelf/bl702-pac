...
pub struct HBN_RSV1_R(crate::FieldReader<u32, u32>);
impl HBN_RSV1_R {
    pub(crate) fn new(bits: u32) -> Self {
        HBN_RSV1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HBN_RSV1_R {
...
impl R {
    ...
    pub fn hbn_rsv1(&self) -> HBN_RSV1_R {
        HBN_RSV1_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn hbn_rsv1(&mut self) -> HBN_RSV1_W {
        HBN_RSV1_W { w: self }
    }
