...
pub type HBN_RSV0_R = crate::FieldReader<u32, u32>;
#[doc = "Field `HBN_RSV0` writer - "]
pub type HBN_RSV0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, HBN_RSV0_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn hbn_rsv0(&mut self) -> HBN_RSV0_W<0> {
        HBN_RSV0_W::new(self)
    }
