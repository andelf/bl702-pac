...
pub type HBN_MODE_R = crate::BitReader<bool>;
...
pub type TRAP_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, HBN_CTL_SPEC, bool, O>;
...
pub type SRAM_SLP_W<'a, const O: u8> = crate::BitWriter<'a, u32, HBN_CTL_SPEC, bool, O>;
#[doc = "Field `hbn_state` reader - "]
pub type HBN_STATE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `hbn_state` writer - "]
pub type HBN_STATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, HBN_CTL_SPEC, u8, u8, 4, O>;
impl R {
    #[doc = "Bits 0:6"]
    #[inline(always)]
