...
impl core::ops::Deref for XTAL32K_LOWV_EN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct XTAL32K_LOWV_EN_W<'a> {
    w: &'a mut W,
}
impl<'a> XTAL32K_LOWV_EN_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl core::ops::Deref for XTAL32K_HIZ_EN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct XTAL32K_HIZ_EN_W<'a> {
    w: &'a mut W,
}
impl<'a> XTAL32K_HIZ_EN_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn xtal32k_lowv_en(&self) -> XTAL32K_LOWV_EN_R {
        XTAL32K_LOWV_EN_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn xtal32k_hiz_en(&self) -> XTAL32K_HIZ_EN_R {
        XTAL32K_HIZ_EN_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 19"]
    ...
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn xtal32k_lowv_en(&mut self) -> XTAL32K_LOWV_EN_W {
        XTAL32K_LOWV_EN_W { w: self }
    }
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn xtal32k_hiz_en(&mut self) -> XTAL32K_HIZ_EN_W {
        XTAL32K_HIZ_EN_W { w: self }
    }
