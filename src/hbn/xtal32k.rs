...
pub type XTAL32K_LOWV_EN_R = crate::BitReader<bool>;
#[doc = "Field `xtal32k_lowv_en` writer - "]
pub type XTAL32K_LOWV_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, XTAL32K_SPEC, bool, O>;
...
impl R {
    ...
    pub fn xtal32k_hiz_en(&self) -> XTAL32K_HIZ_EN_R {
        XTAL32K_HIZ_EN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn xtal32k_lowv_en(&self) -> XTAL32K_LOWV_EN_R {
        XTAL32K_LOWV_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
