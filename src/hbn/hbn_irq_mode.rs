...
pub type HBN_PIN_WAKEUP_MASK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, HBN_IRQ_MODE_SPEC, u8, u8, 5, O>;
#[doc = "Field `reg_aon_pad_ie_smt` reader - "]
pub type REG_AON_PAD_IE_SMT_R = crate::FieldReader<u8, u8>;
...
impl R {
    ...
    pub fn hbn_pin_wakeup_mask(&self) -> HBN_PIN_WAKEUP_MASK_R {
        HBN_PIN_WAKEUP_MASK_R::new(((self.bits >> 3) & 0x1f) as u8)
    }
    #[doc = "Bits 8:12"]
    #[inline(always)]
    pub fn reg_aon_pad_ie_smt(&self) -> REG_AON_PAD_IE_SMT_R {
        REG_AON_PAD_IE_SMT_R::new(((self.bits >> 8) & 0x1f) as u8)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
