...
pub type HBN_TIME_H_R = crate::FieldReader<u8, u8>;
#[doc = "Field `hbn_time_h` writer - "]
pub type HBN_TIME_H_W<'a, const O: u8> = crate::FieldWriter<'a, u32, HBN_TIME_H_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:7"]
    #[inline(always)]
    pub fn hbn_time_h(&mut self) -> HBN_TIME_H_W<0> {
        HBN_TIME_H_W::new(self)
    }
