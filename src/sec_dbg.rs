...
#[doc = "sd_chip_id_low (rw) register accessor: an alias for `Reg<SD_CHIP_ID_LOW_SPEC>`"]
pub type SD_CHIP_ID_LOW = crate::Reg<sd_chip_id_low::SD_CHIP_ID_LOW_SPEC>;
#[doc = "sd_chip_id_low."]
pub mod sd_chip_id_low;
#[doc = "sd_chip_id_high (rw) register accessor: an alias for `Reg<SD_CHIP_ID_HIGH_SPEC>`"]
pub type SD_CHIP_ID_HIGH = crate::Reg<sd_chip_id_high::SD_CHIP_ID_HIGH_SPEC>;
#[doc = "sd_chip_id_high."]
pub mod sd_chip_id_high;
#[doc = "sd_wifi_mac_low (rw) register accessor: an alias for `Reg<SD_WIFI_MAC_LOW_SPEC>`"]
pub type SD_WIFI_MAC_LOW = crate::Reg<sd_wifi_mac_low::SD_WIFI_MAC_LOW_SPEC>;
#[doc = "sd_wifi_mac_low."]
pub mod sd_wifi_mac_low;
#[doc = "sd_wifi_mac_high (rw) register accessor: an alias for `Reg<SD_WIFI_MAC_HIGH_SPEC>`"]
